...
- 이 문서는 `러셀3`의 **1단계 지문 목록** 문서다.
- 실제 날짜 배치는 `docs/russell3_schedule_365.md`에서 관리한다.
- 문서 상태값은 `source_selected`, `scheduled`, `learning_built`만 사용한다.
...
| 수궁가 | classical-prose-excerpt | 로컬 원문 > 진단 테스트 v2/data/russell/R1_LIT_P5/passage.md (다), 참고용 기출 지문/수궁가_작자 미상.md | 2회 | source_selected |
...
| 분야 | 구체 개념 후보 |
|---|---|
| 서양철학 | 존재와 본질, 지식과 믿음, 의무론과 공리주의, 사회계약론, 자유의지와 결정론, 실재론과 반실재론, 덕 윤리, 회의주의 |
| 동양철학 | 성선설과 성악설, 수기치인, 예와 무위자연, 격물치지, 성심과 수양, 왕도 정치, 인의예지, 중용과 과불급 |
| 역사 | 사료의 관점성, 경제 구조 변동, 개혁 정치, 국제 질서 재편, 식민지 지배 구조, 전쟁 동원 체제, 신분제 개편, 산업화와 도시화 |
| 논리학 | 명제와 진리표, 오류 논증, 확률 추론, 귀납과 반례, 가설 검증, 충분조건과 필요조건, 연역 타당성, 반증 가능성 |
| 법학 | 죄형 법정주의, 무효와 취소, 권리 충돌, 절차적 정의, 과실 책임, 위법성 조각, 정당방위와 긴급피난, 입증 책임 |
| 경제학 | 한계 효용과 선택, 시장 실패와 정부 개입, 외부 효과와 조세, 조세 전가, 경기 순환, 가격 탄력성, 정보 비대칭, 게임 이론의 균형 |
| 물리학 | 운동량 보존, 일률과 에너지 전달, 열역학 제2법칙, 파동 간섭, 전기장과 자기장, 단진동과 공명, 유체 압력, 전자기 유도 |
| 화학 | 산화와 환원, 결합 에너지, 반응 엔탈피, 전해질과 이온, 평형 이동, 몰 농도, 촉매와 활성화 에너지, 산과 염기의 평형 |
| 생명과학 | DNA 복제와 단백질 합성, 생태계 평형, 항상성과 신경 조절, 면역 조절과 염증 반응, 유전자 발현 조절, 신경 전달, 개체군 변화, 에너지 대사 |
| 지구과학 | 판 경계와 지진, 지질 시대, 우주 팽창, 기후 변화와 대기 순환, 판 경계와 화산 활동, 해수 순환, 천체 운동, 별의 진화 |
| 기계공학 | 토크와 감속기, 열기관 효율, 유체 저항, 베어링과 윤활, 토크와 동력 전달, 캠과 크랭크, 기계적 진동, 재료의 피로 |
| 전기공학 | 교류와 직류, 반도체와 다이오드, 전력 손실과 송전, 회로 해석, 변압기, 전자기 유도, 트랜지스터 스위칭, 콘덴서 충방전 |
| 의약학 | 약동학과 대사 경로, 면역 조절과 염증 반응, 진통 기전, 치료 지표, 내성과 약물 선택, 수용체와 작동제, 항암제와 세포주기, 항생제와 내성 |
| 데이터알고리즘 | 그래프 탐색과 최단 경로, 해시 충돌과 해결, 동적 계획법, 분할 정복, 정렬 복잡도, 우선순위 큐, 트라이와 문자열 탐색, 그래프 위상 정렬 |
| 인공지능 | 과적합과 정규화, 강화 학습과 보상 설계, 설명 가능성, 학습 데이터 편향, 모델 평가 지표, 생성 모델, 표현 학습, 추천 시스템과 콜드 스타트 |

## 화법·작문·문법 topic 목록

| 영역 | topic 목록 |
|---|---|
| 화법 | 대화 목적 파악, 맥락 추론, 공감하며 듣기, 질문 의도 파악, 발표 핵심 내용, 발표 도입과 마무리, 자료 활용 말하기, 토의 규칙과 역할, 협력적 의사소통, 인터뷰와 발표, 안내와 요청, 설득 전략 |
| 작문 | 글의 목적 정하기, 중심 문장 세우기, 근거 배열하기, 문단 나누기, 개요 짜기, 설명문 조직, 주장문 조직, 서론·본론·결론, 자료 사용하기, 고쳐쓰기, 요약문 쓰기, 제목 붙이기 |
| 문법 | 품사 구별, 체언과 수식언, 용언의 활용, 문장 성분, 주어와 서술어의 호응, 높임 표현, 시간 표현과 시제, 피동과 사동, 부정 표현, 직접 인용과 간접 인용, 문장 부호, 맞춤법과 표준어 |

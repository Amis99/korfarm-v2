...
| 분야 | 구체 개념 후보 |
|---|---|
| 서양철학 | 존재와 본질, 인식론, 의무론, 공리주의, 사회계약, 자유의지, 회의주의 |
| 동양철학 | 성선설과 성악설, 중용, 수기치인, 예악, 왕도 정치, 격물치지, 무위자연 |
| 역사 | 사료의 관점성, 제국과 식민지, 개혁 정치, 국제 질서, 경제 구조 변동, 근대화 |
| 논리학 | 명제와 진리표, 충분조건과 필요조건, 가설 검증, 귀납과 반례, 오류 논증, 확률 추론 |
| 법학 | 죄형 법정주의, 과실 책임, 권리 충돌, 무효와 취소, 위법성 조각, 절차적 정의 |
| 경제학 | 한계 효용, 탄력성, 시장 실패, 외부 효과, 조세 전가, 경기 순환 |
| 물리학 | 운동량 보존, 일률, 전기장, 자기장, 파동 간섭, 열역학 |
| 화학 | 산화 환원, 평형 이동, 몰 농도, 결합 에너지, 반응 엔탈피, 전해질 |
| 생명과학 | DNA 복제, 단백질 합성, 신경 전달, 면역 기억, 생태계 평형, 항상성 |
| 지구과학 | 판 경계, 편서풍 파동, 해수 순환, 지질 시대, 천체 운동, 우주 팽창 |
| 기계공학 | 토크, 감속기, 베어링, 캠과 크랭크, 열기관 효율, 유체 저항 |
| 전기공학 | 교류와 직류, 전력 손실, 반도체, 변압기, 전자기 유도, 회로 해석 |
| 의약학 | 약동학, 내성, 면역 조절, 진통 기전, 대사 경로, 치료 지표 |
| 데이터알고리즘 | 정렬 복잡도, 탐색 구조, 그래프 최단 경로, 동적 계획법, 분할 정복, 해시 충돌 |
| 인공지능 | 과적합, 정규화, 학습 데이터 편향, 모델 평가, 강화 학습, 설명 가능성 |

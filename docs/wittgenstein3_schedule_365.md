...
| 36 | 비문학 | ???? ?? | docs/wittgenstein3_source_inventory.md > exam-nonfiction-law |
| 37 | 문학 | 기황전설 | docs/wittgenstein3_source_inventory.md > 기황전설 |
| 38 | 비문학 | ?? ?? | docs/wittgenstein3_source_inventory.md > exam-nonfiction-science |
| 39 | 화법 | 발표 자료 해석 (유형) | 비트겐슈타인 3 화법 유형 지문 수동 작성 |
| 40 | 작문 | 문단 재배열 (유형) | 비트겐슈타인 3 작문 유형 지문 수동 작성 |

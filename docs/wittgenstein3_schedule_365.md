...
| 101 | 비문학 | ?? ??? | docs/wittgenstein3_source_inventory.md > exam-nonfiction-environment |
| 102 | 화법 | 청자의 반응 추론 (실전) | 비트겐슈타인 3 화법 유형 지문 수동 작성 |
| 103 | 작문 | 자료 통합 구성 (실전) | 비트겐슈타인 3 작문 유형 지문 수동 작성 |
| 104 | 비문학 | ?? ?? ?? | docs/wittgenstein3_source_inventory.md > exam-nonfiction-humanities |
| 105 | 문법 | 형태소와 품사 (실전) | 비트겐슈타인 3 문법 유형 지문 수동 작성 |

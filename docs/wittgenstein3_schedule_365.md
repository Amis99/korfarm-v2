...
| 81 | 화법 | 말하기 태도 판단 (유형) | 비트겐슈타인 3 화법 유형 지문 수동 작성 |
| 82 | 작문 | 소개문 조정 (유형) | 비트겐슈타인 3 작문 유형 지문 수동 작성 |
| 83 | 비문학 | ???? ?? | docs/wittgenstein3_source_inventory.md > exam-nonfiction-society |
| 84 | 문법 | 어문 규범 (유형) | 비트겐슈타인 3 문법 유형 지문 수동 작성 |
| 85 | 비문학 | ?? ?? | docs/wittgenstein3_source_inventory.md > exam-nonfiction-economy |

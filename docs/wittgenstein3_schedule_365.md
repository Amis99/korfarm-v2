...
| 121 | 문학 | 낙토의 아이들 | docs/wittgenstein3_source_inventory.md > 낙토의 아이들 |
| 122 | 비문학 | ?? ?? | docs/wittgenstein3_source_inventory.md > exam-nonfiction-language |
| 123 | 화법 | 설득 전략 분석 (실전) | 비트겐슈타인 3 화법 유형 지문 수동 작성 |
| 124 | 작문 | 고쳐쓰기 전략 (실전) | 비트겐슈타인 3 작문 유형 지문 수동 작성 |
| 125 | 비문학 | ?? ?? | docs/wittgenstein3_source_inventory.md > exam-nonfiction-psychology |

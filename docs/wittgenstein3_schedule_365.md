...
| 141 | 비문학 | ??? | docs/wittgenstein3_source_inventory.md > exam-nonfiction-science |
| 142 | 문학 | 난쟁이가 쏘아 올린 작은 공 | docs/wittgenstein3_source_inventory.md > 난쟁이가 쏘아 올린 작은 공 |
| 143 | 비문학 | ?? ?? | docs/wittgenstein3_source_inventory.md > exam-nonfiction-technology |
| 144 | 화법 | 건의와 협상의 전략 (실전) | 비트겐슈타인 3 화법 유형 지문 수동 작성 |
| 145 | 작문 | 비교·대조 글쓰기 (실전) | 비트겐슈타인 3 작문 유형 지문 수동 작성 |

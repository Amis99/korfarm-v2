...
| 46 | 화법 | 인터뷰의 핵심 정보 (유형) | 비트겐슈타인 3 화법 유형 지문 수동 작성 |
| 47 | 작문 | 개념 정의 방식 (유형) | 비트겐슈타인 3 작문 유형 지문 수동 작성 |
| 48 | 비문학 | ?? ?? | docs/wittgenstein3_source_inventory.md > exam-nonfiction-psychology |
| 49 | 문법 | 훈민정음 원리 (유형) | 비트겐슈타인 3 문법 유형 지문 수동 작성 |
| 50 | 비문학 | ?? ?? | docs/wittgenstein3_source_inventory.md > exam-nonfiction-environment |

...
| 레벨 | 폴더 | 재생성 범위 | 특이사항 |
|------|------|------------|---------|
| 러셀1 | russell1 | Day 1~365 전체 | 비문학=기출지문 사용 |
| 러셀2 | russell2 | Day 1~365 전체 | 비문학=기출지문 사용 |
| 러셀3 | russell3 | Day 1~365 전체 | 비문학=기출지문 사용 |
...
- **RUSSELL 이상 레벨**: `참고용 기출 지문/` 폴더의 원고를 참고하여 레벨에 맞게 재작성 (원문 복사 금지)
  - 비문학(홀수 Day): `참고용 기출 지문/` 내 비문학 원고를 바탕으로 작업하며, 직접 새 주제를 잡지 않는다.
  - 문학(짝수 Day): `참고용 기출 지문/` 내 시, 소설, 수필 등 파일 사용

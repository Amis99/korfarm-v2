    ...
    <div className="features-page">
      ...
      <div className="features-hero">
        <div className="features-wrap">
          ...
          <h1>12레벨 진단 시스템</h1>
          <p>10대 핵심 역량을 측정하는 진단 테스트 — 1인당 평생 1회.</p>
        </div>
      </div>
      ...
      <section className="features-section" style={{ background: "#f2f7f1" }}>
        <div className="features-wrap">
          <div className="features-section-head">
            ...
            <div>
              <h2>진단 테스트</h2>
              <p>1인당 평생 1회 · 학년 자동 매칭</p>
            </div>
          </div>
          <p>진단 테스트는 10대 핵심 역량을 측정하는 표준 진단입니다.</p>
          <div className="features-highlight-list">
            {[
              "1인당 평생 1회 응시 — 무료/유료/기관 모든 회원 동일.",
              "응시자의 학년에 따라 4단계(소쉬르·프레게·러셀·비트겐슈타인) 중 하나로 자동 매칭됩니다.",
              "10대 역량별 점수와 영역·세부영역·주제별 통계를 동시에 산출합니다.",
              "결과에 따라 12레벨 중 가장 적합한 레벨에 자동 배정되고, 즉시 통합 분석표에서 확인할 수 있습니다.",
            ].map((h) => (

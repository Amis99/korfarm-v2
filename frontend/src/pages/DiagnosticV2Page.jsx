  ...
  return (
    <div className="diag-v2-page">
      <div className="diag-v2-header">
        <h1>온라인 역량 진단</h1>
        <p>10대 핵심 역량을 정밀 측정하고 맞춤 학습 레벨을 추천받으세요.</p>
      </div>
          ...
          return (
            ...
            >
              ...
              {tier?.hasCompleted && (
                ...
                >
                  <span className="mode-title">다시 진단하기</span>
                </button>
              )}
            </div>
          );

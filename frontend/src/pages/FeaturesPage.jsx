...
const SECTIONS = [
  {
    ...
    desc: "교재 학습 → 정답/해설 확인 → 챕터 테스트(70점 통과) → 다음 챕터로 이어지는 체계적 학습 시스템입니다. 레벨당 20챕터, 총 12레벨(240챕터)로 구성되며, 6단계 모듈(어휘·문법·독해·논리·정답해설·테스트)을 통해 국어 실력을 단계별로 완성합니다.",
    highlights: [
      "레벨당 20챕터, 12레벨 총 240챕터 구성",
      "6단계 모듈: 어휘 → 문법 → 독해 → 논리 → 정답해설 → 챕터 테스트",
  ...
  },
  {
    ...
    icon: "park",
    title: "농장별 모드",
    subtitle: "9개 영역 전문 농장",
    desc: "어휘농장, 사전농장, 비문학농장, 문학농장, 배경지식농장, 개념농장, 문법농장, 논리농장, 선지분석농장 등 9개 영역별 전문 농장에서 약점을 집중 보강합니다. 각 농장마다 서버별 난이도가 적용되어 체계적인 훈련이 가능합니다.",
    highlights: [
      "9개 전문 영역: 어휘·사전·비문학·문학·배경지식·개념·문법·논리·선지분석",
      "각 농장별 고유한 훈련 방식",
      "서버별 난이도 적용 (프레게~비트겐슈타인)",
      "약점 영역 집중 보강 시스템",
    ],
  },
  {
  ...
  },
  {
    ...
    icon: "emoji_events",
    title: "보상 시스템",
    subtitle: "씨앗 경제, 랭킹, 대결",
    desc: "학습 완료 시 씨앗을 획득하고, 모은 씨앗으로 다양한 수확물을 교환합니다. 시즌 랭킹으로 경쟁하고, 1:1 대결 모드에서 씨앗을 걸고 실시간 퀴즈 대결에 도전할 수 있습니다.",
    highlights: [
      "씨앗 경제: 학습 완료 시 씨앗 획득",
      "수확물 교환: 씨앗으로 아이템 교환",

...
VALUES ('u_hq_admin', 'hqadmin', '$2a$10$pqHcGJCTiyqqM4EifWvD2.cjynlZX9GjmIrl9fp4GBg6e6shEYkoO', '본사관리자', '서울', '국어농장', '-', 'saussure1', 'active', false, NOW(), NOW())
...
INSERT INTO users (id, email, password_hash, name, region, school, grade_label, level_id, status, diagnostic_opt_in, created_at, updated_at)
VALUES ('u_org_admin', 'orgadmin', '$2a$10$pqHcGJCTiyqqM4EifWvD2.cjynlZX9GjmIrl9fp4GBg6e6shEYkoO', '기관관리자', '서울', '테스트학원', '-', 'saussure1', 'active', false, NOW(), NOW())
ON DUPLICATE KEY UPDATE password_hash = VALUES(password_hash);

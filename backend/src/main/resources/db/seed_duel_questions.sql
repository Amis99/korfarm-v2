...
--
-- 서버 구성:
--   saussure     : 초등 저학년 (1~3학년) 수준
--   frege        : 초등 고학년 (4~6학년) 수준
--   russell      : 중학교 수준
...
INSERT INTO duel_question_pool (id, server_id, question_type, category, question_json, status, created_at, updated_at)
VALUES ('dq_frege_background_010', 'frege', 'QUIZ', 'BACKGROUND', '{"id":"dq_frege_background_010","serverId":"frege","questionType":"QUIZ","category":"BACKGROUND","stem":"토끼전에서 용왕이 가져오라고 한 것은?","passage":null,"choices":[{"id":"A","text":"토끼의 간"},{"id":"B","text":"토끼의 꼬리"},{"id":"C","text":"토끼의 귀"},{"id":"D","text":"토끼의 발"}],"answerId":"A","timeLimitSec":30}', 'ACTIVE', NOW(), NOW());
...
INSERT INTO duel_question_pool (id, server_id, question_type, category, question_json, status, created_at, updated_at)
VALUES ('dq_wittgenstein_concept_003', 'wittgenstein', 'QUIZ', 'CONCEPT', '{"id":"dq_wittgenstein_concept_003","serverId":"wittgenstein","questionType":"QUIZ","category":"CONCEPT","stem":"'굳이'가 [구지]로, '같이'가 [가치]로 발음되는 현상을 무엇이라 하나요?","passage":null,"choices":[{"id":"A","text":"음운 축약"},{"id":"B","text":"음운 탈락"},{"id":"C","text":"구개음화"},{"id":"D","text":"모음 조화"}],"answerId":"C","timeLimitSec":30}', 'ACTIVE', NOW(), NOW());
...
INSERT INTO duel_question_pool (id, server_id, question_type, category, question_json, status, created_at, updated_at)
VALUES ('dq_wittgenstein_detail_007', 'wittgenstein', 'READING', 'DETAIL', '{"id":"dq_wittgenstein_detail_007","serverId":"wittgenstein","questionType":"READING","category":"DETAIL","stem":"글의 내용과 일치하는 것은?","passage":"국어의 음운 변동에는 교체, 탈락, 첨가, 축약의 네 유형이 있다. 꽃밭이 [꼳빧]으로 발음되는 것은 음절 끝소리 규칙(교체)과 된소리되기(교체)가 함께 일어난 결과이다. 이처럼 하나의 단어에서 여러 음운 변동이 동시에 적용될 수 있다.","choices":[{"id":"A","text":"음운 변동은 세 유형이다"},{"id":"B","text":"꽃밭에서 음절 끝소리 규칙과 된소리되기가 일어난다"},{"id":"C","text":"하나의 단어에는 하나의 음운 변동만 적용된다"},{"id":"D","text":"교체와 탈락은 같은 현상이다"}],"answerId":"B","timeLimitSec":45}', 'ACTIVE', NOW(), NOW());

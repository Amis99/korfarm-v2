...
\vspace*{40mm}
\begin{center}
{\Huge\bfseries\color{kfPrimary} 러셀2}\\[10pt]
...
\kfStartGrammar{문법 영역 — 단어에게 이름표를! 품사 분류의 원리와 9품사}


\kfSecHeader{kfAreaGrammar}{개념}{단어에게 이름표를! 품사 분류의 원리와 9품사}
...
\noindent\textit{\small 지문의 핵심 내용을 떠올리며 빈칸에 알맞은 말을 채워 보세요.}\par\medskip

\kfSecHeader{kfAreaGrammar}{활동}{분석 훈련}
\noindent\textit{\small 다음 문장에 쓰인 단어들을 체언과 관계언으로 나누어 각각 모두 찾아 쓰시오.}\par\medskip
...
\begin{kfQBlock}{1}{}
\kfQStem{다음 중 품사에 대한 설명으로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
...
\begin{kfEvidence}<보기>      문장에서 다른 말을 꾸며주는 기능을 한다.\end{kfEvidence}
\begin{kfChoices}
\kfChoice 명사, 대명사
\kfChoice 동사, 형용사
\kfChoice 조사, 감탄사
...
\end{kfQBlock}
\begin{kfQBlock}{6}{}
\kfQStem{밑줄 친 단어의 품사가 바르게 연결되지 \uline{않은} 것은?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{8}{}
\kfQStem{문장 속 역할에 대한 설명이 바르지 \uline{않은} 것은?}
\begin{kfChoices}
...
\begin{kfEvidence}<보기>       ㉠은 체언을 꾸며주고, ㉡은 주로 용언을 꾸며준다.\end{kfEvidence}
\begin{kfChoices}
\kfChoice ㉠ 부사, ㉡ 관형사
\kfChoice ㉠ 관형사, ㉡ 부사
\kfChoice ㉠ 명사, ㉡ 동사
...
\kfStartConcept{개념 영역 — 누가, 어떤 상황에서, 무엇을 느꼈을까?}


\kfSecHeader{kfAreaConcept}{개념}{누가, 어떤 상황에서, 무엇을 느꼈을까?}
...
\begin{multicols}{2}\raggedcolumns\setlength{\columnsep}{12pt}
\begin{kfQBlock}{1}{}
\kfQStem{시적 화자에 대한 설명으로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{2}{}
\kfQStem{화자의 정서를 파악하는 방법으로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{4}{}
\kfQStem{다음 <보기>의 시적 화자에 대한 설명으로 적절하지 \uline{않은} 것은?}
\begin{kfEvidence}<보기> 열무 삼십 단을 이고 시장에 간 우리 엄마 안 오시네, 해는 시든지 오래 나는 찬밥처럼 방에 담겨 아무리 천천히 숙제를 해도 엄마 안 오시네 배춧잎 같은 발소리 타박타박 안 들리네, 어둡고 무서워 금간 창 틈으로 고요히 빗소리 빈방에 혼자 엎드려 훌쩍거리던

아주 먼 옛날 지금도 내 눈시울을 뜨겁게 하는 그 시절, 내 유년의 윗목. — 기형도 「엄마 걱정」\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfEvidence}<보기> 엄마야 누나야 강변 살자, 뜰에는 반짝이는 금모래빛, 뒷문 밖에는 갈잎의 노래, 엄마야 누나야 강변 살자. — 김소월 「엄마야 누나야」\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfEvidence}내를 건너서 숲으로 고개를 넘어서 마을로 어제도 가고 오늘도 갈 나의 길, 새로운 길 민들레가 피고 까치가 날고 아가씨가 지나고 바람이 일고 나의 길은 언제나 새로운 길 오늘도... 내일도... 내를 건너서 숲으로 고개를 넘어서 마을로 — 윤동주 「새로운 길」\end{kfEvidence}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{7}{}
\kfQStem{이 시의 화자가 ‘나의 길’에 대해 느끼는 정서로 적절하지 \uline{않은} 것은?}
\begin{kfEvidence}내를 건너서 숲으로 고개를 넘어서 마을로 어제도 가고 오늘도 갈 나의 길, 새로운 길 민들레가 피고 까치가 날고 아가씨가 지나고 바람이 일고 나의 길은 언제나 새로운 길 오늘도... 내일도... 내를 건너서 숲으로 고개를 넘어서 마을로 — 윤동주 「새로운 길」\end{kfEvidence}
\begin{kfChoices}
...
\kfSecHeader{kfAreaLiterature}{지문}{문장 독해 — 발췌 문장}
...
\kfSecHeader{kfAreaLiterature}{지문}{해설 학습 — 본문}
...
\noindent\textit{\small 다음은 작품에서 발췌한 문장입니다. 각 문장을 읽고 물음에 답하시오.}\par\medskip
...
\kfSecHeader{kfAreaLiterature}{활동}{해설 학습 — 단답 묶음}
\noindent\textit{\small 해설 본문을 읽고, 단원별 단답형 물음에 답하시오.}\par\medskip
\begin{enumerate}[leftmargin=22pt, itemsep=6pt, topsep=4pt, label=\textbf{\arabic*.}]
...
\end{kfQBlock}
\begin{kfQBlock}{5}{}
\kfQStem{1연의 ‘바람’과 3연의 ‘바람’에 대한 설명으로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{6}{}
\kfQStem{이 시의 표현 방식에 대한 설명으로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
...
\begin{kfEvidence}<보기> 윤동주는 일제 강점기에 활동했던 시인이다. 그는 일본 유학 중 독립운동 혐의로 체포되어 감옥에서 생을 마감했다. 그의 시에는 이러한 시대적 아픔 속에서 고뇌하는 지식인의 모습과 자기희생을 통해 조국의 구원을 바라는 마음이 잘 나타나 있다.\end{kfEvidence}
\begin{kfChoices}
...
\kfStartNonlit{비문학 영역 — [인문] 양심을 통한 최대 행복 실현, 밀의 공리주의}


\kfSecHeader{kfAreaNonlit}{지문}{[인문] 양심을 통한 최대 행복 실현, 밀의 공리주의}
...
\kfSecHeader{kfAreaNonlit}{지문}{문장 독해 — 본문 문장}
...
\noindent\textit{\small 다음은 본문의 번호 매긴 문장입니다. 각 문장을 읽고 물음에 답하시오.}\par\medskip
\begin{kfSentenceUnit}{1}{}
...
\noindent\textit{\small 글의 전체적인 논리 흐름을 파악하며 빈칸에 알맞은 내용을 채워 보세요.}\par\medskip
\begin{kfStructure}
\kfNode{0}{}{}
\end{kfStructure}
...
\begin{multicols}{2}\raggedcolumns\setlength{\columnsep}{12pt}
\begin{kfQBlock}{1}{}
\kfQStem{윗글에 대한 설명으로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{3}{}
\kfQStem{밀과 밀 이전 공리주의의 입장을 비교한 것으로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{4}{}
\kfQStem{㉠ ‘양심’에 대한 밀의 설명에서 추론할 수 있는 내용으로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
...
\kfStartGrammar{문법 영역 — 문장의 핵심 재료인 체언, 문법적 관계를 맺는 관계언}


\kfSecHeader{kfAreaGrammar}{개념}{문장의 핵심 재료인 체언, 문법적 관계를 맺는 관계언}
...
\kfSecHeader{kfAreaGrammar}{활동}{분석 훈련}
\noindent\textit{\small 다음 문장을 읽고, 설명에 해당하는 단어를 모두 찾아 써 보세요.}\par\medskip
\begin{enumerate}[leftmargin=22pt, itemsep=6pt, topsep=4pt, label=\textbf{\arabic*.}]
...
\end{kfQBlock}
\begin{kfQBlock}{2}{}
\kfQStem{체언에 대한 설명으로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{6}{}
\kfQStem{다음 중 홀로 쓰일 수 \uline{없는} 품사는?}
\begin{kfChoices}
\kfChoice 명사
\kfChoice 대명사
\kfChoice 수사
...
\begin{kfEvidence}<보기> ㉠\uline{이것}은 ㉡\uline{나}의 ㉢\uline{하나}뿐인 보물이다.\end{kfEvidence}
\begin{kfChoices}
\kfChoice ㉠:명사, ㉡:대명사, ㉢:수사
\kfChoice ㉠:대명사, ㉡:대명사, ㉢:수사
\kfChoice ㉠:대명사, ㉡:명사, ㉢:조사
...
\end{kfQBlock}
\begin{kfQBlock}{9}{}
\kfQStem{다음 중 대명사가 \uline{없는} 문장은?}
\begin{kfChoices}
...
\begin{kfEvidence}<보기> 문장의 뼈대를 이루며, 주로 주어, 목적어 등으로 사용된다.\end{kfEvidence}
\begin{kfChoices}
\kfChoice 명사, 동사
\kfChoice 명사, 대명사, 수사
\kfChoice 동사, 형용사
...
\kfStartConcept{개념 영역 — 소설, 지금 누가 이야기하고 있을까?}


\kfSecHeader{kfAreaConcept}{개념}{소설, 지금 누가 이야기하고 있을까?}
...
\begin{multicols}{2}\raggedcolumns\setlength{\columnsep}{12pt}
\begin{kfQBlock}{1}{}
\kfQStem{소설의 서술자에 대한 설명으로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{2}{}
\kfQStem{1인칭 시점과 3인칭 시점을 구분하는 기준에 대한 설명으로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{3}{}
\kfQStem{1인칭 주인공 시점에 대한 설명으로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{4}{}
\kfQStem{3인칭 관찰자 시점의 효과에 대한 설명으로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
...
\begin{kfEvidence}<보기> 다음 날 나는 유치원에서 돌아오면서 ‘오늘은 엄마를 좀 기쁘게 해 드리고 싶은데, 무얼 갖다 드리면 기뻐하실까？’ 하는 궁리를 했어요.
...
그런데 엄마는 그 꽃을 꽃병에 꽂아서 풍금 위에 놓아두었어요. 며칠 뒤 꽃이 시들자 줄기는 잘라 버리고 꽃송이만 찬송가 갈피에 얌전하게 넣어 두셨어요.   - 주요섭 「사랑손님과 어머니」\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{6}{}
\kfQStem{다음 <보기>의 서술상 특징에 대한 설명으로 가장 적절한 것은?}
\begin{kfEvidence}<보기> 나흘 전 감자 쪼간(건, 사건)만 하더라도 나는 저에게 조금도 잘못한 것은 없다. 계집애가 나물을 캐러 가면 갔지 남 울타리 엮는 데 쌩이질(한창 바쁠 때에 쓸데없는 일로 남을 귀찮게 구는 짓)을 하는 것은 다 뭐냐.
...
잔소리를 두루 늘어놓다가 남이 들을까 봐 손으로 입을 틀어막고는 그 속에서 깔깔댄다. 별로 우스울 것도 없는데 날씨가 풀리더니 이 놈의 계집애가 미쳤나 하고 의심하였다.   - 김유정 「동백꽃」\end{kfEvidence}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{7}{}
\kfQStem{이야기의 서술자를 ‘나’에서 ‘그’로 바꾸었을 때 나타나는 변화로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{4}{}
\kfQStem{「사랑손님과 어머니」의 '옥희'처럼, '나'가 주인공이 아닌 주변 인물로서 주인공을 관찰하는 시점은 무엇인가?}
\kfAnswerLines{1}
\end{kfQBlock}
\begin{kfQBlock}{5}{}
...
\end{kfQBlock}
\begin{kfQBlock}{3}{}
\kfQStem{이 소설의 서술상 특징이 주는 효과에 대한 설명으로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{5}{}
\kfQStem{㉠\textasciitilde{}㉤ 중, '나'의 어수룩한 모습을 알 수 있는 부분이 \uline{아닌} 것은?}
\begin{kfChoices}
...
\kfStartNonlit{비문학 영역 — [사회] 미성년자 보호를 위한 계약 취소 제도}


\kfSecHeader{kfAreaNonlit}{지문}{[사회] 미성년자 보호를 위한 계약 취소 제도}
...
\begin{kfEvidence}㉠ 취소권 배제 ㉡ 확답 촉구권 ㉢ 철회권\end{kfEvidence}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{4}{}
\kfQStem{<보기>의 상황에 윗글을 적용한 판단으로 적절하지 \uline{않은} 것은?}
\begin{kfEvidence}<보기> 18세 A는 부모님 몰래 100만 원짜리 최신형 스마트폰을 구매하여 사용했다. 한 달 뒤 이 사실을 알게 된 A의 부모는 계약을 취소하려고 한다. A는 그동안 스마트폰을 사용하여 약간의 흠집이 생겼다.\end{kfEvidence}
\begin{kfChoices}
...
\kfStartGrammar{문법 영역 — 활용하는 용언, 꾸며주는 수식언, 홀로 쓰는 독립언}


\kfSecHeader{kfAreaGrammar}{개념}{활용하는 용언, 꾸며주는 수식언, 홀로 쓰는 독립언}
...
\kfSecHeader{kfAreaGrammar}{활동}{분석 훈련}
\noindent\textit{\small 다음 문장을 읽고, 설명에 해당하는 단어를 모두 찾아 쓰시오.}\par\medskip
\begin{enumerate}[leftmargin=22pt, itemsep=6pt, topsep=4pt, label=\textbf{\arabic*.}]
...
\begin{multicols}{2}\raggedcolumns\setlength{\columnsep}{12pt}
\begin{kfQBlock}{1}{}
\kfQStem{다음 중 용언에 대한 설명으로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{6}{}
\kfQStem{밑줄 친 단어의 품사가 부사가 \uline{아닌} 것은?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{8}{}
\kfQStem{‘활용’에 대한 설명으로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
...
\begin{kfEvidence}<보기> * 수식언은 활용을 (   ). * 문장 속에서 형태가 고정되어 있다.\end{kfEvidence}
\begin{kfChoices}
\kfChoice 한다
\kfChoice 하지 않는다
\kfChoice 할 수도 있다
...
\end{kfQBlock}
\begin{kfQBlock}{15}{}
\kfQStem{다음 문장에 대한 분석으로 옳지 \uline{않은} 것은?}
...
\kfStartConcept{개념 영역 — 마음속에 그려지는 그림, 심상}


\kfSecHeader{kfAreaConcept}{개념}{마음속에 그려지는 그림, 심상}
...
\begin{kfEvidence}<보기> 해야 솟아라. 해야 솟아라. 말갛게 씻은 얼굴 고운 해야 솟아라.
...
\begin{kfQBlock}{2}{}
\kfQStem{<보기>의 시구에서 중심적으로 사용된 심상은?}
\begin{kfEvidence}<보기> 바람맛도 짭짤한 물맛도 짭짤한
...
\begin{kfEvidence}<보기> • 서늘한 옷자락에 열로 상기한 볼을 말없이 부비는 것이었다.
...
\end{kfQBlock}
\begin{kfQBlock}{4}{}
\kfQStem{<보기>의 (가)\textasciitilde{}(마)에 대한 설명으로 적절하지 \uline{않은} 것은?}
\begin{kfEvidence}<보기> (가) 청색의 손바닥을 불빛 속에 적셔두고
...
\begin{kfEvidence}<보기> 금빛 게으른 울음을 우는 곳
...
\end{kfQBlock}
\begin{kfQBlock}{6}{}
\kfQStem{<보기>의 시에 대한 감상으로 적절하지 \uline{않은} 것은?}
\begin{kfEvidence}<보기> 해와 하늘빛이
...
\begin{kfEvidence}<보기> 아, 강낭콩꽃보다도 더 푸른
...
\begin{kfEvidence}<보기> • 어두운 방 안엔 바알간 숯불이 피고
...
\begin{kfEvidence}해야 솟아라. 해야 솟아라. 말갛게 씻은 얼굴 고운 해야 솟아라. 산 넘어 산 넘어서 어둠을 살라 먹고, 산 넘어서 밤새도록 어둠을 살라 먹고, 이글이글 애띤 얼굴 고운 해야 솟아라. - 박두진, 「해」\end{kfEvidence}
\kfAnswerNote{답안}{4}
\end{kfQBlock}
\end{multicols}
...
\end{kfQBlock}
\begin{kfQBlock}{6}{}
\kfQStem{이 시의 화자를 ‘나’에서 ‘엄마’로 바꾸어 다시 쓸 때 나타나는 효과로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{7}{}
\kfQStem{다음은 시를 감상한 학생들의 대화이다. 내용이 적절하지 \uline{않은} 학생은?}
\begin{kfEvidence}민수: ‘해는 시든 지 오래’라는 표현에서 시간이 많이 흘렀다는 것과 함께 어두운 분위기를 시각적으로 느낄 수 있었어. 지혜: 화자를 ‘찬밥’에 비유하고 시의 마지막을 ‘윗목’으로 끝낸 것에서 화자가 느꼈을 차가운 외로움이 잘 전해졌어. 준호: ‘타박타박’이나 ‘빗소리’ 같은 소리를 나타내는 말을 사용해서, 혼자 있는 빈방의 적막함이 더 생생하게 느껴졌어. 서연: ‘열무’나 ‘찬밥’ 같은 음식을 소재로 사용해서 배고팠던 어린 시절의 서러움을 미각적으로 표현하고 있어. 현우: ‘아주 먼 옛날’과 ‘지금도’라는 말을 통해, 과거의 아픈 기억이 현재까지 이어지고 있다는 것을 알 수 있었어.\end{kfEvidence}
\begin{kfChoices}
\kfChoice 민수
\kfChoice 지혜
\kfChoice 준호
...
\kfStartNonlit{비문학 영역 — [과학] 중력을 이기는 식물의 물 운반 비밀}


\kfSecHeader{kfAreaNonlit}{지문}{[과학] 중력을 이기는 식물의 물 운반 비밀}
...
\end{kfQBlock}
\begin{kfQBlock}{2}{}
\kfQStem{윗글에 나타난 세 가지 힘에 대한 설명으로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
...
\begin{kfEvidence}<보기> 컵에 물을 담고 휴지 한쪽 끝을 담가 두었더니, 잠시 후 물이 휴지를 타고 올라와 젖지 않았던 부분까지 번져 나갔다.\end{kfEvidence}
\begin{kfChoices}
\kfChoice 광합성
\kfChoice 뿌리압
\kfChoice 모세관 현상
...
\end{kfQBlock}
\begin{kfQBlock}{4}{}
\kfQStem{윗글을 바탕으로 추론한 내용으로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{5}{}
\kfQStem{식물이 물을 끌어 올리는 힘을 작용 방식에 따라 분류한 설명으로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
...
\kfStartGrammar{문법 영역 — 단어의 구조를 파헤치다: 형태소, 어근, 접사}


\kfSecHeader{kfAreaGrammar}{개념}{단어의 구조를 파헤치다: 형태소, 어근, 접사}
...
\kfSecHeader{kfAreaGrammar}{활동}{분석 훈련}
\noindent\textit{\small 다음 문장이나 단어를 읽고, 설명에 맞게 분석하시오.}\par\medskip
\begin{enumerate}[leftmargin=22pt, itemsep=6pt, topsep=4pt, label=\textbf{\arabic*.}]
...
\begin{multicols}{2}\raggedcolumns\setlength{\columnsep}{12pt}
\begin{kfQBlock}{1}{}
\kfQStem{다음 중 형태소에 대한 설명으로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
...
\begin{kfEvidence}<보기> 아기가 ㉠놀이터에서 논다. 여기서 '놀이터'는 ㉡'놀-'이라는 중심 의미에 '-이-'와 '-터'가 붙어 만들어졌다.\end{kfEvidence}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{5}{}
\kfQStem{다음 밑줄 친 부분 중 문법적 기능을 하는 형식 형태소가 \uline{아닌} 것은?}
\begin{kfChoices}
\kfChoice \uline{하늘}이 맑다.
...
\end{kfQBlock}
\begin{kfQBlock}{6}{}
\kfQStem{밑줄 친 부분이 접두사가 \uline{아닌} 것은?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{9}{}
\kfQStem{밑줄 친 부분에 대한 분석이 바르지 \uline{않은} 것은?}
...
\end{kfQBlock}
\begin{kfQBlock}{11}{}
\kfQStem{다음 중 접미사가 붙어 만들어진 단어가 \uline{아닌} 것은?}
\begin{kfChoices}
\kfChoice 구경꾼
\kfChoice 낚시꾼
\kfChoice 장난꾸러기
...
\begin{kfEvidence}<보기> 의존 형태소 + 의존 형태소\end{kfEvidence}
\begin{kfChoices}
\kfChoice 하늘
\kfChoice 밥물
\kfChoice 손잡이
...
\end{kfQBlock}
\begin{kfQBlock}{15}{}
\kfQStem{단어 '짓밟히다'에 대한 분석으로 옳지 \uline{않은} 것은?}
\begin{kfChoices}
\kfChoice 어근은 '밟-'이다.
\kfChoice '짓-'은 접두사이다.
\kfChoice '-히-'는 접미사이다.
...
\kfStartConcept{개념 영역 — 소설 구성의 3요소: 인물, 사건, 배경}


\kfSecHeader{kfAreaConcept}{개념}{소설 구성의 3요소: 인물, 사건, 배경}
...
\begin{multicols}{2}\raggedcolumns\setlength{\columnsep}{12pt}
\begin{kfQBlock}{1}{}
\kfQStem{소설 구성의 3요소에 대한 설명으로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{2}{}
\kfQStem{소설의 ‘인물’에 대한 설명으로 적절하지 \uline{않은} 것은 무엇인가?}
\begin{kfChoices}
...
\begin{kfEvidence}<보기> 새침하게 흐린 품이 눈이 올 듯하더니, 눈은 아니 오고 얼다가 만 비가 추적추적 내리는 날이었다. 이 날이야말로 동소문 안에서 인력거꾼 노릇을 하는 김 첨지에게는 오래간만에도 닥친 운수 좋은 날이었다.
...
\end{kfQBlock}
\begin{kfQBlock}{5}{}
\kfQStem{‘반동 인물’의 역할에 대한 설명으로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
...
\begin{kfEvidence}<보기> 춘향이 신관 사또의 수청을 거부하여 옥에 갇히고, 이몽룡은 과거에 급제하여 암행어사가 되어 남원으로 향한다.\end{kfEvidence}
\begin{kfChoices}
\kfChoice 발단
\kfChoice 전개
\kfChoice 위기
...
\end{kfQBlock}
\begin{kfQBlock}{10}{}
\kfQStem{<보기>의 인물 성격 제시 방법에 대한 설명으로 적절하지 \uline{않은} 것은?}
\begin{kfEvidence}<보기> 그리고 뭣에 떠다밀렸는지 나의 어깨를 짚은 채 그대로 퍽 쓰러진다. 그 바람에 나의 몸뚱이도 겹쳐서 쓰러지며, 한창 피어 퍼드러진 노란 동백꽃 속으로 폭 파묻혀 버렸다.
...
\end{kfQBlock}
\begin{kfQBlock}{11}{}
\kfQStem{「홍길동전」에서 ‘홍길동’이 서자라는 신분 때문에 겪는 갈등에 대한 설명으로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
...
\kfStartLit{문학 영역 — 꺼삐딴 리}


\kfSecHeader{kfAreaLiterature}{지문}{꺼삐딴 리}
\kfPassageNote{꺼삐딴 리}{%
...
\begin{multicols}{2}\raggedcolumns\setlength{\columnsep}{12pt}
\begin{kfQBlock}{1}{}
\kfQStem{이 글의 서술상 특징에 대한 설명으로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{4}{}
\kfQStem{이인국 박사에 대한 설명으로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
...
\begin{kfEvidence}<보기> 소설에서 국기는 흔히 그 나라의 주권이나 권력을 상징한다. 따라서 인물이 어떤 국기를 바라보는지는 그가 어떤 권력에 의지하고 있는지를 보여주는 장치가 될 수 있다. \end{kfEvidence}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{7}{}
\kfQStem{이 글에 드러난 이인국 박사의 말과 행동으로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{9}{}
\kfQStem{소설의 제목이 ‘꺼삐딴 리’인 이유에 대한 설명으로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{10}{}
\kfQStem{이 소설을 통해 작가가 말하고자 하는 바에 대한 설명으로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
...
\kfStartNonlit{비문학 영역 — [기술] 말소리를 글자로 바꾸는 컴퓨터의 비밀}


\kfSecHeader{kfAreaNonlit}{지문}{[기술] 말소리를 글자로 바꾸는 컴퓨터의 비밀}
...
\begin{multicols}{2}\raggedcolumns\setlength{\columnsep}{12pt}
\begin{kfQBlock}{1}{}
\kfQStem{윗글에서 설명하는 음성 인식의 핵심 원리에 대한 설명으로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{5}{}
\kfQStem{다음 <보기>와 같은 상황에서 만들어질 수 \uline{없는} 입력 패턴은?}

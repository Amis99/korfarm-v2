...
\kfChapterAreaItem{문법}{kfAreaGrammar}{문장 속 단어들의 역할 (품사)}
\kfChapterAreaItem{개념}{kfAreaConcept}{표현을 생생하게 만드는 비유법}
\kfChapterAreaItem{문학}{kfAreaLiterature}{「빼앗긴 들에도 봄은 오는가」}
\kfChapterAreaItem{비문학}{kfAreaNonlit}{[인문] 내 마음의 다섯 가지 욕구, 현실요법}
\end{kfChapterAreaList}

\kfStartGrammar{문장 속 단어들의 역할 (품사)}
...
\kfActivityBg \par\kfMaybeNeedspace{32\baselineskip}\noindent{\kfTipMark\,\,}{\small\color{kfInk} 아래 표의 빈칸에 알맞은 말을 채워 문법 내용을 확인해 보자.}\par\nopagebreak[4]\smallskip\nopagebreak[4]
* 품사 분류의 세 가지 기준 *
...
\begin{tabular}{|>{\raggedright\arraybackslash}p{\dimexpr 0.3303\linewidth-12pt\relax}|>{\raggedright\arraybackslash}p{\dimexpr 0.4650\linewidth-12pt\relax}|>{\raggedright\arraybackslash}p{\dimexpr 0.2047\linewidth-12pt\relax}|}
\hline
\rowcolor{kfPrimaryLight!50}\textbf{\color{kfPrimary} 형태} & \textbf{\color{kfPrimary} 기능} & \textbf{\color{kfPrimary} 의미} \\\hline
\multirow{4}{*}{[ ① \_\_\_\_\_\_ ] (형태가 변하지 않음)} & [ ② \_\_\_\_\_\_ ] (문장의 몸통) & 명사, 대명사, 수사 \\\cline{2-3}
 & [ ③ \_\_\_\_\_\_ ] (관계 표시) & 조사 \\\cline{2-3}
 & [ ④ \_\_\_\_\_\_ ] (꾸며주는 말) & 관형사, 부사 \\\cline{2-3}
 & [ ⑤ \_\_\_\_\_\_ ] (독립적인 말) & 감탄사 \\\cline{2-3}
...
\par\kfMaybeNeedspace{24\baselineskip}\noindent{\kfTipMark\,\,}{\small\color{kfInk}  9품사 분류 훈련! 다음 단어의 품사를 9품사 중 하나로 쓰시오.}\par\nopagebreak[4]\smallskip\nopagebreak[4]
\kfBeginMC
...
\kfQStem{품사를 나누는 세 가지 기준에 대한 설명으로 적절하지 \uline{\underline{않은}} 것은?}
\begin{kfChoices}
...
\kfQStem{'수식언'에 대한 설명으로 옳지 \uline{\underline{않은}} 것은?}
\begin{kfChoices}
...
\kfQStem{문장 속에서 형태가 변하지 않는 '불변어'가 \uline{\underline{아닌}} 것은?}
\begin{kfChoices}
\kfChoice 하늘
\kfChoice 그리고
\kfChoice 깨끗하다
...
\kfQStem{'용언'에 대한 설명으로 옳지 \uline{\underline{않은}} 것은?}
\begin{kfChoices}
...
\kfStartConcept{표현을 생생하게 만드는 비유법}
...
\kfBeginMC
\begin{kfQBlock}{01}{객관식}
\kfQStem{비유법을 사용하는 이유로 적절하지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{02}{객관식}
\kfQStem{"내 마음은 호수요"라는 표현에 대한 설명으로 알맞지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{03}{객관식}
\kfQStem{다음 중 직유법을 만들기 위해 사용되는 말이 \uline{\underline{아닌}} 것은 무엇인가?}
\begin{kfChoices}
\kfChoice 같이
\kfChoice 이다
\kfChoice 듯이
...
\end{kfQBlock}
\begin{kfQBlock}{04}{객관식}
\kfQStem{"가르마 같은 논길"이라는 표현에 대한 설명으로 알맞지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{05}{객관식}
\kfQStem{은유법에 대한 설명으로 적절하지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{06}{객관식}
\kfQStem{다음 중, 사람처럼 표현한 대상이 \uline{\underline{아닌}} 것은 무엇인가?}
\begin{kfChoices}
...
\kfQStem{비유법에 대한 설명으로 알맞지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\par\kfMaybeNeedspace{32\baselineskip}\noindent{\kfTipMark\,\,}{\small\color{kfInk} 작품 속 문장을 자세히 읽고, 문장별로 주어진 물음에 답해 보자.}\par\nopagebreak[4]\smallskip\nopagebreak[4]
\kfBeginMC
...
\kfActivityBg \kfSecHeader{kfAreaLiterature}{활동}{해설 학습}
\par\kfMaybeNeedspace{32\baselineskip}\noindent{\kfTipMark\,\,}{\small\color{kfInk} 작품 해설을 단원별로 읽고, 각 단원에 딸린 물음에 답해 보자.}\par\nopagebreak[4]\smallskip\nopagebreak[4]
\par\medskip
\kfPassageNoteNT{%
...
\end{kfQBlock}
\begin{kfQBlock}{02}{객관식}
\kfQStem{말하는 이가 봄의 들판을 걸으며 느끼는 주된 감정으로 알맞지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{03}{객관식}
\kfQStem{이 시에서 ‘빼앗긴 들’이 상징하는 의미로 적절하지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{04}{객관식}
\kfQStem{“푸른 웃음과 푸른 슬픔이 섞인 사이로”라는 구절에 담긴 말하는 이의 심정으로 적절하지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{07}{객관식}
\kfQStem{이 시에서 대상에 대한 말하는 이의 정서 및 태도에 대한 설명으로 알맞지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\kfStartNonlit{[인문] 내 마음의 다섯 가지 욕구, 현실요법}
...
\par\kfMaybeNeedspace{32\baselineskip}\noindent{\kfTipMark\,\,}{\small\color{kfInk} 지문을 문장 단위로 정독하면서, 문장별로 주어진 물음에 답해 보자.}\par\nopagebreak[4]\smallskip\nopagebreak[4]
\kfBeginMC
...
\kfActivityBg \par\kfMaybeNeedspace{32\baselineskip}\noindent{\kfTipMark\,\,}{\small\color{kfInk} 글의 흐름을 살펴보고, 구조도의 빈칸을 알맞게 채워 보자.}\par\nopagebreak[4]\smallskip\nopagebreak[4]
...
\multirow{2}{*}{1문단} & 인간의 모든 행동 & ( ① )을 이루기 위한 ( ② ) \\\cline{2-3}
 & 문제 해결 방법 & 마음속 욕구들의 ( ③ ) 맞추기 \\\cline{2-3}
\hline
\multirow{5}{*}{2문단} & 욕구 1 & ( ④ ) 싶은 마음 \\\cline{2-3}
 & 욕구 2 & ( ⑤ ) 싶은 마음 \\\cline{2-3}
 & 욕구 3 & ( ⑥ )받고 싶은 마음 \\\cline{2-3}
 & 욕구 4 & ( ⑦ ) 싶은 마음 \\\cline{2-3}
 & 욕구 5 & ( ⑧ ) 살고 싶은 마음 \\\cline{2-3}
\hline
\multirow{2}{*}{3문단} & 원인 & 사람마다 다섯 가지 마음의 ( ⑨ )가 다르기 때문 \\\cline{2-3}
 &  & 사례 및 해결책 제시 \\\cline{2-3}
\hline
\multirow{2}{*}{4문단} & 핵심 목표 & 다른 사람을 존중하며 ( ⑩ ) 좋은 선택을 하도록 돕는 것 \\\cline{2-3}
 & 현재 & 많은 ( ⑪ )을 받으며 넓게 사용되고 있음 \\\cline{2-3}
\hline
\end{tabularx}
\arrayrulecolor{black}
...
\kfBeginMC
\begin{kfQBlock}{01}{객관식}
\kfQStem{윗글의 중심 내용으로 적절하지 \uline{\underline{않은}} 것은?}
\begin{kfChoices}
...
\begin{kfChapterAreaList}
\kfChapterAreaItem{문법}{kfAreaGrammar}{문장의 뼈대를 세우는 말 (명사, 대명사, 수사)}
\kfChapterAreaItem{개념}{kfAreaConcept}{이야기가 펼쳐지는 시간과 공간}
\kfChapterAreaItem{문학}{kfAreaLiterature}{「메밀꽃 필 무렵」}
\kfChapterAreaItem{비문학}{kfAreaNonlit}{[사회] 어떤 방법이 가장 공정할까? 여러 가지 투표 방식}
\end{kfChapterAreaList}

\kfStartGrammar{문장의 뼈대를 세우는 말 (명사, 대명사, 수사)}
...
\renewcommand{\arraystretch}{1.45}
\arrayrulecolor{kfRule}
\begin{tabular}{|>{\raggedright\arraybackslash}p{\dimexpr 0.2318\linewidth-12pt\relax}|>{\raggedright\arraybackslash}p{\dimexpr 0.4374\linewidth-12pt\relax}|>{\raggedright\arraybackslash}p{\dimexpr 0.3307\linewidth-12pt\relax}|}
\hline
...
\kfActivityBg \kfSecHeader{kfAreaGrammar}{활동}{분석 훈련}
\par\kfMaybeNeedspace{24\baselineskip}\noindent{\kfTipMark\,\,}{\small\color{kfInk}  명사, 대명사, 수사 찾기 훈련! 문장에서 명사(이름), 대명사(이름 대신), 수사(숫자)에 해당하는 단어를 모두 찾아 쓰시오.}\par\nopagebreak[4]\smallskip\nopagebreak[4]
\kfBeginMC
\begin{enumerate}[leftmargin=22pt, itemsep=6pt, topsep=4pt, label=\textbf{\arabic*.}]
...
\end{kfQBlock}
\begin{kfQBlock}{04}{객관식}
\kfQStem{다음 중 수량을 나타내는 수사가 \uline{\underline{아닌}} 것은?}
\begin{kfChoices}
\kfChoice 하나
\kfChoice 일곱
\kfChoice 아홉
...
\end{kfQBlock}
\begin{kfQBlock}{07}{객관식}
\kfQStem{다음 중 품사의 연결이 바르지 \uline{\underline{않은}} 것은?}
\begin{kfChoices}
\kfChoice 의자 - 명사
\kfChoice 그녀 - 대명사
\kfChoice 다섯 - 수사
...
\begin{kfEvidence}가. 그는 책 하나를 샀다. \\\relax
나. 그것은 그녀의 가방이다.\end{kfEvidence}
\begin{kfChoices}
...
\kfStartConcept{이야기가 펼쳐지는 시간과 공간}
...
\kfBeginMC
\begin{kfQBlock}{01}{객관식}
\kfQStem{소설의 ‘배경’에 대한 설명으로 적절하지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{02}{객관식}
\kfQStem{박지원의 「허생전」이 ‘묵적골’·‘남산’ 같은 실제 지명을 사용한 이유로 적절하지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{03}{객관식}
\kfQStem{현진건의 「운수 좋은 날」에서 ‘비’가 내리는 배경이 주는 효과로 적절하지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{04}{객관식}
\kfQStem{<보기>의 ‘소나기’ 배경이 이야기 전개에 한 역할로 적절하지 \uline{\underline{않은}} 것은 무엇인가?}
...
\end{kfQBlock}
\begin{kfQBlock}{05}{객관식}
\kfQStem{<보기>의 ‘장마’가 상징하는 의미로 적절하지 \uline{\underline{않은}} 것은 무엇인가?}
...
\end{kfQBlock}
\begin{kfQBlock}{08}{객관식}
\kfQStem{다음 중 소설 속 배경의 기능으로 알맞지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{09}{객관식}
\kfQStem{이효석의 「메밀꽃 필 무렵」에서 ‘달빛 비치는 메밀꽃밭’ 배경이 주는 분위기로 적절하지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{10}{객관식}
\kfQStem{소설의 배경에 대한 설명으로 적절하지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{02}{객관식}
\kfQStem{이 소설에서 ‘달밤과 메밀꽃밭’이라는 배경이 하는 역할로 적절하지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{04}{객관식}
\kfQStem{허 생원의 이야기를 듣는 조 선달의 역할로 적절하지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{06}{객관식}
\kfQStem{동이가 허 생원의 아들일지도 모른다고 암시하는 단서로 적절하지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{08}{객관식}
\kfQStem{이 글의 표현상 특징으로 알맞지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\kfStartNonlit{[사회] 어떤 방법이 가장 공정할까? 여러 가지 투표 방식}
...
\hline
\rowcolor{kfPrimaryLight!40}\textbf{\color{kfPrimary}단} & \textbf{\color{kfPrimary}항목} & \textbf{\color{kfPrimary}내용} \\\hline
\multirow{3}{*}{1문단} & 배경 & 사람들마다 ( ① )이 다름 \\\cline{2-3}
 & 필요성 & ( ② )을 하나로 모으는 과정이 필요 \\\cline{2-3}
 & 주제 소개 & 다양한 ( ③ ) 방식의 특징과 장단점 \\\cline{2-3}
\hline
\multirow{4}{*}{2문단} & 방법 & ( ⑤ )이 넘는 찬성으로 결정 \\\cline{2-3}
 & 장점 & 간단하고 ( ⑥ ) \\\cline{2-3}
 & 단점 1 & 좋아하는 크기를 반영하지 못해 ( ⑦ ) 의 사람들이 피해를 봄 \\\cline{2-3}
 & 단점 2 & 대결 순서에 따라 ( ⑧ )가 바뀔 수 있음 \\\cline{2-3}
\hline
\multirow{2}{*}{3문단} & 방법 & 주어진 ( ⑩ )를 자유롭게 나누어 투표 \\\cline{2-3}
 & 장점 & 각자가 의견을 얼마나 좋아하는지 그 마음의 ( ⑪ )를 자세히 표현할 수 있음  단점: ( ⑫ )인 행동이 나타날 수 있음 \\\cline{2-3}
\hline
\multirow{2}{*}{4문단} & 방법 & 모든 후보의 ( ⑭ )를 매겨 점수 부여 \\\cline{2-3}
 & 특징 & ( ⑮ )한 의견이 뽑힐 가능성이 높음 \\\cline{2-3}
\hline
\multirow{2}{*}{5문단} & 요약 & 투표 방식마다 ( ⑯ )과 단점이 뚜렷함 \\\cline{2-3}
 & 주장 & ( ⑰ )에 맞는 방식을 선택하는 지혜가 필요 \\\cline{2-3}
\hline
\end{tabularx}
\arrayrulecolor{black}
\end{tcolorbox}\par\medskip
...
\begin{kfChapterAreaList}
\kfChapterAreaItem{문법}{kfAreaGrammar}{단어를 이어주는 풀 (조사)}
\kfChapterAreaItem{개념}{kfAreaConcept}{시의 머리와 꼬리가 만나는 수미상관}
\kfChapterAreaItem{문학}{kfAreaLiterature}{「산에 언덕에」 — 신동엽}
\kfChapterAreaItem{비문학}{kfAreaNonlit}{[과학] 식물은 어떻게 높은 곳까지 물을 끌어올릴까?}
\end{kfChapterAreaList}

\kfStartGrammar{단어를 이어주는 풀 (조사)}
...
\renewcommand{\arraystretch}{1.45}
\arrayrulecolor{kfRule}
\begin{tabular}{|>{\raggedright\arraybackslash}p{\dimexpr 0.0286\linewidth-12pt\relax}|>{\raggedright\arraybackslash}p{\dimexpr 0.5017\linewidth-12pt\relax}|>{\raggedright\arraybackslash}p{\dimexpr 0.4698\linewidth-12pt\relax}|}
\hline
...
\multirow{3}{*}{종류} & [ ③ \_\_\_\_\_\_ ]  문장에서의 문법적 자격을 나타냄 & 동생\uline{이} 빵\uline{을} 먹는다. \\\cline{2-3}
 & [ ④ \_\_\_\_\_\_ ]  특별한 의미를 더해줌 & 나는 학생, 나\uline{도} 학생, 나\uline{만} 학생 \\\cline{2-3}
 & [ ⑤ \_\_\_\_\_\_ ]  두 단어를 같은 자격으로 이어줌 & 너\uline{와} 나, 사과\uline{랑} 배 \\\cline{2-3}
\hline
\end{tabular}
\arrayrulecolor{black}
\end{adjustbox}\par\medskip
...
\kfActivityBg \kfSecHeader{kfAreaGrammar}{활동}{분석 훈련}
\par\kfMaybeNeedspace{24\baselineskip}\noindent{\kfTipMark\,\,}{\small\color{kfInk}  조사 찾기 훈련! 문장에서 조사에 해당하는 단어를 모두 찾아 쓰시오.}\par\nopagebreak[4]\smallskip\nopagebreak[4]
\kfBeginMC
\begin{enumerate}[leftmargin=22pt, itemsep=6pt, topsep=4pt, label=\textbf{\arabic*.}]
\item 하늘이 푸르고 바다가 넓다.
\item 나는 밥을 먹었다.
...
\kfBeginMC
\begin{kfQBlock}{01}{객관식}
\kfQStem{조사에 대한 설명으로 옳지 \uline{\underline{않은}} 것은?}
\begin{kfChoices}
...
\begin{kfEvidence}* 나\_\_ 학생이다. \\\relax
* 사과\_\_ 맛있다.\end{kfEvidence}
\begin{kfChoices}
\kfChoice 는
\kfChoice 를
\kfChoice 만
...
\begin{kfEvidence}* 철수\_\_ 학교에 간다. \\\relax
* 나는 사과\_\_ 먹는다.\end{kfEvidence}
\begin{kfChoices}
\kfChoice 가, 를
\kfChoice 는, 도
\kfChoice 가, 만
...
\kfStartConcept{시의 머리와 꼬리가 만나는 수미상관}
...
\kfBeginMC
\begin{kfQBlock}{01}{객관식}
\kfQStem{‘수미상관’에 대한 설명으로 적절하지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{02}{객관식}
\kfQStem{‘수미상관(首尾相關)’의 한자 뜻풀이에 대한 설명으로 적절하지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{03}{객관식}
\kfQStem{수미상관이 시의 형식에 주는 효과로 적절하지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{05}{객관식}
\kfQStem{수미상관이 시의 내용에 주는 효과로 적절하지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{07}{객관식}
\kfQStem{다음 중 수미상관의 효과로 알맞지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{08}{객관식}
\kfQStem{다음 중 수미상관에 대한 설명으로 알맞지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\kfBeginMC
\begin{kfQBlock}{01}{객관식}
\kfQStem{‘그’의 죽음에 대한 말하는 이의 태도로 적절하지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{02}{객관식}
\kfQStem{이 시에서 ‘꽃’과 ‘숨결’이 공통적으로 상징하는 의미로 적절하지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{04}{객관식}
\kfQStem{‘\textasciitilde{}ㄹ지어이’라는 말의 반복이 만들어 내는 효과로 적절하지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{05}{객관식}
\kfQStem{이 시의 수미상관 구조가 만들어 내는 효과로 적절하지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{06}{객관식}
\kfQStem{이 시의 ‘그’가 4·19 혁명 때 희생된 젊은 학생들을 상징한다고 할 때, 이 시의 주제로 적절하지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\kfStartNonlit{[과학] 식물은 어떻게 높은 곳까지 물을 끌어올릴까?}
...
\hline
\rowcolor{kfPrimaryLight!40}\textbf{\color{kfPrimary}단} & \textbf{\color{kfPrimary}항목} & \textbf{\color{kfPrimary}내용} \\\hline
\multirow{2}{*}{1문단} & 문제 상황 & ( ① )은 물을 아래로 끌어당김 \\\cline{2-3}
 & 핵심 질문 & 키 큰 나무가 어떻게 꼭대기까지 ( ② )을 보낼까? \\\cline{2-3}
\hline
\multirow{2}{*}{2문단} & 나무가 물을 끌어올리는 비결 & ( ③ ) 가지 힘의 조화 \\\cline{2-3}
 & 세 가지 힘의 이름 & 뿌리압, ( ④ ) 현상, 증산 작용 \\\cline{2-3}
\hline
\multirow{7}{*}{3-5문단: 세 가지 힘의 원리} & 힘 1 & ( ⑤ ) (밀어 올리는 힘) \\\cline{2-3}
 & 원리 & 뿌리 안과 밖의 ( ⑥ ) 차이로 물이 들어와 압력 발생 \\\cline{2-3}
 & 힘 2 & 모세관 현상 (타고 올라가는 힘) \\\cline{2-3}
 & 원리 & 가는 ( ⑦ ) 벽에 물 분자가 달라붙어 올라감 \\\cline{2-3}
 & 힘 3 & ( ⑧ ) (끌어당기는 힘) \\\cline{2-3}
 & 원리 & ( ⑨ )에서 물이 수증기로 빠져나가면서 연결된 물줄기를 당김 \\\cline{2-3}
 & 특징 & 가장 ( ⑩ ) 힘 \\\cline{2-3}
\hline
6문단 & 최종 정리 & 세 가지 힘을 ( ⑪ )롭게 이용하여 꼭대기까지 물을 보냄 \\\hline
\end{tabularx}
\arrayrulecolor{black}
\end{tcolorbox}\par\medskip
\kfSecHeader{kfAreaNonlit}{문제}{}
...
\end{kfQBlock}
\begin{kfQBlock}{04}{객관식}
\kfQStem{윗글을 통해 알 수 있는 내용이 \uline{\underline{아닌}} 것은?}
\begin{kfChoices}
...
\begin{kfChapterAreaList}
\kfChapterAreaItem{문법}{kfAreaGrammar}{움직임과 상태를 나타내는 말 (동사, 형용사)}
\kfChapterAreaItem{개념}{kfAreaConcept}{조선 시대의 노래, 시조}
\kfChapterAreaItem{문학}{kfAreaLiterature}{「강호사시가」}
\kfChapterAreaItem{비문학}{kfAreaNonlit}{[기술] 가상과 현실의 만남, 가상현실과 증강현실}
\end{kfChapterAreaList}

\kfStartGrammar{움직임과 상태를 나타내는 말 (동사, 형용사)}
...
\renewcommand{\arraystretch}{1.45}
\arrayrulecolor{kfRule}
\begin{tabular}{|>{\raggedright\arraybackslash}p{\dimexpr 0.1511\linewidth-12pt\relax}|>{\raggedright\arraybackslash}p{\dimexpr 0.4466\linewidth-12pt\relax}|>{\raggedright\arraybackslash}p{\dimexpr 0.4024\linewidth-12pt\relax}|}
\hline
\rowcolor{kfPrimaryLight!50}\textbf{\color{kfPrimary} 구 분} & \textbf{\color{kfPrimary} 설 명} & \textbf{\color{kfPrimary} 예 시} \\\hline
...
\kfActivityBg \kfSecHeader{kfAreaGrammar}{활동}{분석 훈련}
\par\kfMaybeNeedspace{24\baselineskip}\noindent{\kfTipMark\,\,}{\small\color{kfInk}  동사, 형용사 찾기 훈련! 문장에 쓰인 동사와 형용사를 모두 찾아 ‘-다’로 끝나는 원래 모습(기본형)으로 써 보자.}\par\nopagebreak[4]\smallskip\nopagebreak[4]
\kfBeginMC
\begin{enumerate}[leftmargin=22pt, itemsep=6pt, topsep=4pt, label=\textbf{\arabic*.}]
\item 귀여운 아기가 잠을 잔다.
\item 나는 재미있는 영화를 봤다.
...
\kfBeginMC
\begin{kfQBlock}{01}{객관식}
\kfQStem{지문의 내용으로 보아 ‘시조’에 대한 설명으로 적절하지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{02}{객관식}
\kfQStem{평시조의 형식적 특징으로 알맞지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{03}{객관식}
\kfQStem{시조가 ‘정형시’로서 지켜야 할 규칙으로 적절하지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{05}{객관식}
\kfQStem{시조의 종장에 대한 설명으로 적절하지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{06}{객관식}
\kfQStem{맹사성의 「강호사시가」에 대한 설명으로 적절하지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\begin{kfEvidence}개를 여라믄이나 기르되 요 개같이 얄미우랴 \\\relax
미운 임 오며는 꼬리를 홰홰 치며 칩뛰락 나리뛰락 반겨서 내닫고 고운 임 오며는 뒷발을 버둥버둥 므르락 나으락 캉캉 짖어서 도라가게 한다 \\\relax
쉰밥이 그릇그릇 난들 너 머길 줄이 이시랴\end{kfEvidence}
\begin{kfChoices}
\kfChoice 평시조
\kfChoice 연시조
\kfChoice 사설시조
...
\end{kfQBlock}
\begin{kfQBlock}{08}{객관식}
\kfQStem{사설시조에 대한 설명으로 알맞지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\kfBeginMC
\begin{kfQBlock}{01}{객관식}
\kfQStem{이 시의 각 계절 노래마다 공통적으로 반복되는 내용으로 적절하지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{02}{객관식}
\kfQStem{이 시에 나타난 말하는 이의 삶의 태도로 적절하지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{05}{객관식}
\kfQStem{<하사(여름 노래)>에서 ‘믿음직한 강물’이라는 표현에 담긴 의미로 적절하지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{06}{객관식}
\kfQStem{이 시에 대한 설명으로 알맞지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{08}{객관식}
\kfQStem{이 시가 우리나라 시의 역사에서 중요한 작품으로 평가받는 이유로 적절하지 \uline{\underline{않은}} 것은 무엇인가?}
\begin{kfChoices}
...
\kfStartNonlit{[기술] 가상과 현실의 만남, 가상현실과 증강현실}
...
\hline
\rowcolor{kfPrimaryLight!40}\textbf{\color{kfPrimary}단} & \textbf{\color{kfPrimary}항목} & \textbf{\color{kfPrimary}내용} \\\hline
\multirow{3}{*}{1문단} & 공통점 & 상상을 현실로 만드는 ( ① ) 체험 기술 \\\cline{2-3}
 & 차이점 & ( ② ) 방식의 차이 \\\cline{2-3}
 & 질문 & 두 기술은 무엇이며 어떻게 다른가? \\\cline{2-3}
\hline
\multirow{4}{*}{2문단} & 개념 & 완전히 ( ④ )된 새로운 디지털 세상 \\\cline{2-3}
 & 체험 방식 & 머리에 쓰는 기기로 시야를 완전히 ( ⑤ ) \\\cline{2-3}
 & 특징 & 높은 ( ⑥ ) \\\cline{2-3}
 & 예시 & 바닷속 탐험, 가상 여행 \\\cline{2-3}
\hline
\multirow{4}{*}{3문단} & 개념 & ( ⑧ ) 세계 위에 가상의 정보를 ( ⑨ ) 기술 \\\cline{2-3}
 & 체험 방식 & 스마트폰 ( ⑩ )로 실제 환경을 비춤 \\\cline{2-3}
 & 특징 & ( ⑪ )을 유지하며 정보 획득 \\\cline{2-3}
 & 예시 & 포켓몬 잡는 게임, 가구 배치 앱 \\\cline{2-3}
\hline
\multirow{4}{*}{4문단} &  & 핵심 차이점 \\\cline{2-3}
 & 가상현실 & 현실과 ( ⑫ )된 새로운 공간 창조 \\\cline{2-3}
 & 증강현실 & 현실 세계를 ( ⑬ ) \\\cline{2-3}
 & 미래 전망 & 게임을 넘어 교육, 의료 등 다양한 분야로 발전 \\\cline{2-3}
\hline
\end{tabularx}
\arrayrulecolor{black}
\end{tcolorbox}\par\medskip
...
\end{kfQBlock}
\begin{kfQBlock}{02}{객관식}
\kfQStem{가상현실(VR)과 증강현실(AR)의 차이점에 대한 설명으로 적절하지 \uline{\underline{않은}} 것은?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{04}{객관식}
\kfQStem{다음 중 ‘가상현실(VR)’ 기술의 예시로 적절하지 \uline{\underline{않은}} 것은?}
\begin{kfChoices}

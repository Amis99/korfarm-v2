...
\vspace*{40mm}
\begin{center}
{\Huge\bfseries\color{kfPrimary} 소쉬르1}\\[10pt]
...
\kfStartVocab{어휘 영역 — 핵심 어휘 익히기}


\kfSecHeader{kfAreaVocab}{어휘}{핵심 어휘 익히기}
...
\kfStartConcept{개념 영역 — 핵심 어휘 익히기}


\kfSecHeader{kfAreaConcept}{활동}{핵심 어휘 익히기}
\noindent\textit{\small 다음 단어와 알맞은 설명을 연결해 보세요.}\par\medskip
\begin{kfConnect}
\kfPair{눈}{사물을 봐요}
\kfPair{코}{소리를 들어요}
\kfPair{입}{만져서 느껴요}
...
\kfSecHeader{kfAreaConcept}{개념}{배경지식 넓히기: 우리 몸을 지켜 주는 '감각'}
...
\kfSecHeader{kfAreaConcept}{활동}{배경지식 넓히기: 우리 몸을 지켜 주는 '감각'}
\noindent\textit{\small 다음 문장이 옳으면 O, 옳지 않으면 X를 표시하세요.}\par\medskip
\begin{kfOXList}
\kfOXItem 감각은 우리를 즐겁게 해 줄 뿐만 아니라, 위험할 때 몸을 지켜 주기도 해요. ( ) \kfOX
\kfOXItem 뜨거운 주전자에 손이 닿았을 때 위험을 알려 주는 감각은 '후각'이에요. ( ) \kfOX
\kfOXItem 자동차 소리를 듣고 안전한 곳으로 피하게 해 주는 것은 '청각' 덕분이에요. ( ) \kfOX
\end{kfOXList}

\kfSecHeader{kfAreaConcept}{활동}{감각을 나타내는 말}
\noindent\textit{\small 다음 문장에 어울리는 감각을 나타내는 말을 고르세요.}\par\medskip
\begin{kfBlankList}
...
\kfAnswerNote{답안}{4}
\end{kfQBlock}
\par\noindent\textit{\small * 나는 ( ) 이(가) 가장 고마워요. * 왜냐하면 \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_}

\kfSecHeader{kfAreaLiterature}{활동}{창의 활동: 꼬마 작사가 되어보기}
...
\kfSecHeader{kfAreaLiterature}{글쓰기}{창의 활동: 꼬마 작사가 되어보기}

\kfWritingPrompt{동요에 나오지 않은 다른 신체 부위를 넣거나 재미있는 흉내 내는 말(의성어·의태어)을 넣어 나만의 노랫말을 만들어 보세요.}
\kfWriting{글쓰기 답안}{12}


\kfStartNonlit{비문학 영역 — 동물들의 슈퍼 감각}


\kfSecHeader{kfAreaNonlit}{지문}{동물들의 슈퍼 감각}
...
* 매는 사람보다 8배나 더 잘 보는 (        )을 가지고 있어요. * 개는 (        )를 아주 잘 맡아서 잃어버린 물건을 찾아요. * 토끼는 긴 귀로 아주 작은 (        )도 잘 들을 수 있어요.
\begin{kfEvidence}<보기> 냄새, 눈, 소리, 코, 맛\end{kfEvidence}
\end{kfBlankList}

\kfSecHeader{kfAreaNonlit}{문제}{}

\begin{kfQBlock}{4}{}
\kfQStem{이 글에서 설명하지 \uline{않은} 동물은 누구인가요?}
\begin{kfChoices}
\kfChoice 매
\kfChoice 개
\kfChoice 고양이
...
\kfSecHeader{kfAreaNonlit}{활동}{창의 활동: 내가 갖고 싶은 슈퍼 감각}
\noindent\textit{\small 주어진 안내에 맞춰 자유롭게 글로 표현해 보세요.}\par\medskip
\kfWritingPrompt{만약 여러분이 동물들의 슈퍼 감각 중 하나를 가질 수 있다면, 무엇을 갖고 싶은가요? 그리고 그 감각으로 무엇을 하고 싶은지 상상해서 써 보세요.}
\kfWriting{답안 작성}{8}

\kfSecHeader{kfAreaNonlit}{글쓰기}{창의 활동: 내가 갖고 싶은 슈퍼 감각}
...
\begin{kfQBlock}{3}{}
\kfQStem{㉠과 같이 모양이나 소리를 흉내 내는 말이 \uline{아닌} 것은 무엇인가요?}
\begin{kfChoices}
\kfChoice 킁킁킁
\kfChoice 냠냠냠
\kfChoice 소중해
...
\begin{kfQBlock}{5}{}
\kfQStem{다음 중 이 동시에 나오지 않은 신체 부위는 어디인가요?}
\begin{kfChoices}
\kfChoice 귀
\kfChoice 발
\kfChoice 입
...
\begin{kfQBlock}{10}{}
\kfQStem{다음 중 '입'이 하는 일이 \uline{아닌} 것은 무엇인가요?}
\begin{kfChoices}
...
\kfSecHeader{kfAreaConcept}{개념}{배경지식 넓히기: 마음의 날씨, 감정}
...
\kfSecHeader{kfAreaConcept}{활동}{배경지식 넓히기: 마음의 날씨, 감정}
\noindent\textit{\small 다음 문장이 옳으면 O, 옳지 않으면 X를 표시하세요.}\par\medskip
\begin{kfOXList}
\kfOXItem 사람의 마음은 날씨처럼 매일 변할 수 있어요. ( ) \kfOX
\kfOXItem 화가 나거나 슬픈 마음은 나쁜 것이니 무조건 숨겨야 해요. ( ) \kfOX
\kfOXItem '두려움'은 무섭거나 겁이 나는 마음을 말해요. ( ) \kfOX
\end{kfOXList}

\kfSecHeader{kfAreaConcept}{활동}{감정을 나타내는 말}
\noindent\textit{\small 다음 상황에 어울리는 감정 단어를 골라 동그라미 하세요.}\par\medskip
\begin{kfBlankList}
...
\end{kfQBlock}
\begin{kfQBlock}{3}{}
\kfQStem{다음 중 이 동시에 나오지 않은 감정은 무엇인가요?}
\begin{kfChoices}
\kfChoice 기쁨
\kfChoice 심심함
\kfChoice 슬픔
...
\kfStartNonlit{비문학 영역 — 감정의 종류와 표현법}


\kfSecHeader{kfAreaNonlit}{지문}{감정의 종류와 표현법}
...
* 기쁠 때는 (       )을/를 지으며 기분을 나눠요. * 슬플 때는 억지로 참지 말고 (       )을/를 흘려도 괜찮아요. * 화가 날 때는 소리를 지르는 대신 (       )으로 표현해요.
\begin{kfEvidence}<보기> 말, 눈물, 웃음, 짜증, 부끄러움\end{kfEvidence}
\end{kfBlankList}
...
\kfSecHeader{kfAreaNonlit}{활동}{창의 활동: 감정 해결사}
\noindent\textit{\small 주어진 안내에 맞춰 자유롭게 글로 표현해 보세요.}\par\medskip
\kfWritingPrompt{친구가 실수로 내 공책을 찢었어요. 너무 속상하고 화가 나요. 이때 친구에게 어떻게 말하면 좋을까요?}
\kfWriting{답안 작성}{8}

\kfSecHeader{kfAreaNonlit}{글쓰기}{창의 활동: 감정 해결사}
...
\begin{kfQBlock}{5}{}
\kfQStem{다음 중 이 동시에서 다루지 않은 감정은 무엇인가요?}
\begin{kfChoices}
\kfChoice 기쁨
\kfChoice 슬픔
\kfChoice 부러움
...
\kfSecHeader{kfAreaConcept}{활동}{핵심 어휘 익히기}
\noindent\textit{\small 다음 단어와 알맞은 설명을 선으로 연결해 보세요.}\par\medskip
\begin{kfConnect}
...
\kfSecHeader{kfAreaConcept}{개념}{배경지식 넓히기: 하루를 나누는 기준}
...
\kfSecHeader{kfAreaConcept}{활동}{배경지식 넓히기: 하루를 나누는 기준}
\noindent\textit{\small 다음 문장이 옳으면 O, 옳지 않으면 X를 표시하세요.}\par\medskip
\begin{kfOXList}
\kfOXItem 하루를 오전과 오후로 나누는 기준은 '정오'입니다. ( ) \kfOX
\kfOXItem 오후는 해가 뜨기 시작해서 낮 12시가 될 때까지를 말합니다. ( ) \kfOX
\kfOXItem '일과'는 날마다 규칙적으로 하는 하루 동안의 일을 뜻합니다. ( ) \kfOX
\end{kfOXList}

\kfSecHeader{kfAreaConcept}{개념}{시간의 순서 배열하기}
...
\kfSecHeader{kfAreaConcept}{활동}{시간의 순서 배열하기}
\noindent\textit{\small 다음 단어들을 시간의 흐름 순서대로 나열하여 번호를 쓰세요.}\par\medskip
\begin{kfBlankList}
\kfBlankItem (  ) 정오 (  ) 오전 (  ) 오후
\kfBlankItem (  ) 내일 (  ) 어제 (  ) 오늘
\kfBlankItem (  ) 점심 (  ) 아침 (  ) 밤 (  ) 저녁
\kfBlankItem (  ) 여름 (  ) 봄 (  ) 겨울 (  ) 가을
\end{kfBlankList}
...
\kfAnswerNote{답안}{4}
\end{kfQBlock}
\par\noindent\textit{\small * 나는 ( )을/를 가장 중요하게 생각해요. * 왜냐하면 ( )}

\kfSecHeader{kfAreaLiterature}{활동}{창의 활동: 나만의 일과표 만들기}
\noindent\textit{\small 주어진 안내에 맞춰 자유롭게 글로 표현해 보세요.}\par\medskip
\kfWritingPrompt{내일 꼭 지키고 싶은 일을 '오전'과 '오후'로 나누어 계획해 보세요.}
\kfWriting{답안 작성}{8}

\kfSecHeader{kfAreaLiterature}{글쓰기}{창의 활동: 나만의 일과표 만들기}

\kfWritingPrompt{내일 꼭 지키고 싶은 일을 '오전'과 '오후'로 나누어 계획해 보세요.}
\kfWriting{글쓰기 답안}{12}


\kfStartNonlit{비문학 영역 — 시각을 읽는 법}


\kfSecHeader{kfAreaNonlit}{지문}{시각을 읽는 법}
...
* 시계의 짧은 바늘은 (       )을/를 알려 줍니다. * 시계의 긴 바늘은 (       )을/를 알려 줍니다. * 시침과 분침이 모두 12를 가리키는 낮 시간을 (       )라고 합니다.
\begin{kfEvidence}<보기> 시각, 시, 분, 정오, 오전, 오후\end{kfEvidence}
\end{kfBlankList}
...
\kfSecHeader{kfAreaNonlit}{활동}{창의 활동: 내가 가장 좋아하는 시간}
\noindent\textit{\small 주어진 안내에 맞춰 자유롭게 글로 표현해 보세요.}\par\medskip
\kfWritingPrompt{하루 중에 내가 가장 좋아하는 시간은 언제인가요? 무엇을 할 때인지 써 보세요.}
\kfWriting{답안 작성}{8}

\kfSecHeader{kfAreaNonlit}{글쓰기}{창의 활동: 내가 가장 좋아하는 시간}
...
\kfSecHeader{kfAreaConcept}{개념}{배경지식 넓히기: 마음을 전하는 '편지'}
...
\kfSecHeader{kfAreaConcept}{활동}{배경지식 넓히기: 마음을 전하는 '편지'}
\noindent\textit{\small 다음 문장이 옳으면 O, 옳지 않으면 X를 표시하세요.}\par\medskip
\begin{kfOXList}
\kfOXItem 편지는 받는 사람, 첫인사, 내용, 끝인사, 보낸 사람의 순서로 씁니다. ( ) \kfOX
\kfOXItem 편지는 말로 하기 힘든 마음을 전할 때 좋은 방법입니다. ( ) \kfOX
\kfOXItem '안부'는 윗어른을 공손하게 모신다는 뜻입니다. ( ) \kfOX
\end{kfOXList}

\kfSecHeader{kfAreaConcept}{활동}{편지 형식 알기}
\noindent\textit{\small 편지를 쓸 때 들어갈 내용으로 알맞은 곳에 번호를 쓰세요.}\par\medskip
\begin{kfBlankList}
\kfBlankItem ( 1 ) 받는 사람 ( 2 ) 첫인사 ( 3 ) 쓴 날짜와 보낸 사람

* (  ) 사랑하는 할머니께 * (  ) 2024년 5월 8일 손자 민수 올림 * (  ) 할머니, 그동안 건강하셨나요?
\end{kfBlankList}
...
\end{kfQBlock}
\begin{kfQBlock}{3}{}
\kfQStem{민수가 설날에 할머니 댁에 가서 하겠다고 약속한 일이 아닌 것은 무엇인가요?}
\begin{kfChoices}
\kfChoice 발차기 시범 보이기
\kfChoice 붕어빵 사 가기
...
\kfAnswerNote{답안}{4}
\end{kfQBlock}
\par\noindent\textit{\small * 민수는 할머니가 ( ) 마음으로 편지를 썼을 거예요.}

\kfSecHeader{kfAreaLiterature}{활동}{창의 활동: 마음을 전하는 한마디}
\noindent\textit{\small 주어진 안내에 맞춰 자유롭게 글로 표현해 보세요.}\par\medskip
\kfWritingPrompt{여러분이 사랑하는 가족 중 한 명에게 하고 싶은 말을 짧게 써 보세요.}
\kfWriting{답안 작성}{8}

\kfSecHeader{kfAreaLiterature}{글쓰기}{창의 활동: 마음을 전하는 한마디}

\kfWritingPrompt{여러분이 사랑하는 가족 중 한 명에게 하고 싶은 말을 짧게 써 보세요.}
\kfWriting{글쓰기 답안}{12}


\kfStartNonlit{비문학 영역 — 우리 가족을 소개합니다}


\kfSecHeader{kfAreaNonlit}{지문}{우리 가족을 소개합니다}
...
* 아빠는 등산을 할 때 힘들어하는 저를 (       )해 주십니다. * 엄마는 요리 솜씨가 좋고, 제 이야기를 잘 (       ) 주십니다. * 형은 장난꾸러기지만 저를 잘 챙겨 주는 (       )가 깊은 형입니다.
\begin{kfEvidence}<보기> 우애, 들어, 격려, 화목, 친절\end{kfEvidence}
\end{kfBlankList}
...
\kfSecHeader{kfAreaNonlit}{활동}{창의 활동: 우리 가족 자랑하기}
\noindent\textit{\small 주어진 안내에 맞춰 자유롭게 글로 표현해 보세요.}\par\medskip
\kfWritingPrompt{우리 가족 중 한 사람을 골라 자랑하고 싶은 점을 써 보세요.}
\kfWriting{답안 작성}{8}

\kfSecHeader{kfAreaNonlit}{글쓰기}{창의 활동: 우리 가족 자랑하기}

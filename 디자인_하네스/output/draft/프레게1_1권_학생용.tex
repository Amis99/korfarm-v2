...
\vspace*{40mm}
\begin{center}
{\Huge\bfseries\color{kfPrimary} 프레게1}\\[10pt]
...
\kfStartVocab{어휘 영역 — 분류와 조직 관련 핵심 어휘}
...
\kfSecHeader{kfAreaVocab}{활동}{분류와 조직 관련 핵심 어휘}
\noindent\textit{\small [1-4] 다음 빈칸에 알맞은 어휘를 넣으세요.}\par\medskip
\begin{kfBlankList}
...
\kfStartGrammar{문법 영역 — 중심 생각과 뒷받침 문장}


\kfSecHeader{kfAreaGrammar}{개념}{중심 생각과 뒷받침 문장}

중심 생각(주제문): 문단에서 가장 중요한 내용을 담고 있는 문장.

뒷받침 문장(보조문): 중심 생각을 설명하거나 예시를 들어 구체화하는 문장들.

\kfSecHeader{kfAreaGrammar}{활동}{문장의 중심 생각 찾기}
\noindent\textit{\small 지시어가 가리키는 대상을 찾아 답해 보세요.}\par\medskip
...
\kfSecHeader{kfAreaGrammar}{활동}{헷갈리기 쉬운 낱말 바로 알기}
\noindent\textit{\small [1-3] 문장의 뜻에 알맞은 낱말을 골라 O표 하세요.}\par\medskip
\begin{enumerate}[leftmargin=22pt, itemsep=6pt, topsep=4pt, label=\textbf{\arabic*.}]
...
\begin{kfEvidence}<보기>   ㉠ 규칙적인 운동은 건강을 유지하는 가장 좋은 방법이다. ㉡ 운동을 하면 심장이 튼튼해진다. ㉢ 또한 근육이 강해지고 뼈가 단단해진다. ㉣ 무엇보다 스트레스가 줄어들어 정신 건강에도 도움이 된다.\end{kfEvidence}
\begin{kfChoices}
\kfChoice ㉠ 문장
\kfChoice ㉡ 문장
\kfChoice ㉢ 문장
...
\begin{kfEvidence}<보기>   아침에는 시원한 물 한 잔으로 시작한다. 식사할 때마다 물을 마신다. 운동 후에는 충분한 수분을 보충한다.\end{kfEvidence}
\begin{kfChoices}
...
\kfStartConcept{개념 영역 — 생각을 정리하는 것이 학습에 미치는 영향}


\kfSecHeader{kfAreaConcept}{개념}{생각을 정리하는 것이 학습에 미치는 영향}
...
\kfSecHeader{kfAreaConcept}{활동}{생각을 정리하는 것이 학습에 미치는 영향}
\noindent\textit{\small [1-3] 위 글의 내용과 일치하면 O, 일치하지 않으면 X 표시를 하세요.}\par\medskip
\begin{kfOXList}
...
\kfSecHeader{kfAreaLiterature}{활동}{창의 활동: 나만의 정리 방법 만들기}
\noindent\textit{\small [1-1] 창의 활동: 나만의 정리 방법 만들기}\par\medskip
...
\kfSecHeader{kfAreaLiterature}{활동}{생각 나누기: 정리의 효과}
...
\begin{kfQBlock}{1}{}
\kfQStem{지우가 고민하는 일로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
\kfChoice 다음 주 발표 준비
\kfChoice 엄마의 심부름
\kfChoice 친구와의 약속
...
\kfStartNonlit{비문학 영역 — 생각을 분류하고 조직하는 법}


\kfSecHeader{kfAreaNonlit}{지문}{생각을 분류하고 조직하는 법}
...
\kfSecHeader{kfAreaNonlit}{활동}{글의 구조와 내용 파악하기}
\noindent\textit{\small 다음은 각 문단의 핵심 내용을 정리한 것입니다. 빈칸에 알맞은 말을 채워 넣으세요.}\par\medskip
\begin{kfStructure}
\kfNode{0}{}{}
\kfNode{0}{}{}
\kfNode{0}{}{}
...
\kfSecHeader{kfAreaNonlit}{활동}{실천 활동: 나의 생각 분류해보기}
\noindent\textit{\small [1-2] 오늘 하루 동안 떠오른 생각들을 분류해 보세요.}\par\medskip
...
\end{kfQBlock}
\begin{kfQBlock}{2}{}
\kfQStem{글쓴이가 제시한 생각 정리 방법이 \uline{아닌} 것은?}
\begin{kfChoices}
\kfChoice 범주화
\kfChoice 우선순위 정하기
\kfChoice 시각화
...
\end{kfQBlock}
\begin{kfQBlock}{1}{}
\kfQStem{'범주화'의 예시로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
...
\begin{kfQBlock}{4}{}
\kfQStem{수민이가 지우에게 제안한 방법으로 알맞지 \uline{않은} 것은?}
\begin{kfChoices}
...
\begin{kfQBlock}{9}{}
\kfQStem{중심 생각과 뒷받침 문장에 대한 설명으로 바르지 \uline{않은} 것은?}
\begin{kfChoices}
...
\begin{kfEvidence}① 규칙적인 운동은 건강을 지키는 좋은 습관입니다. 　② 운동을 하면 근육이 튼튼해집니다. 　③ 또한 운동은 스트레스를 줄여주는 효과도 있습니다. 　④ 밤에 잠을 잘 자게 도와주기도 합니다.\end{kfEvidence}
\begin{kfChoices}
\kfChoice ①번 문장
\kfChoice ②번 문장
\kfChoice ③번 문장
...
\kfStartVocab{어휘 영역 — 개요와 구조 관련 핵심 어휘}
...
\kfSecHeader{kfAreaVocab}{활동}{개요와 구조 관련 핵심 어휘}
\noindent\textit{\small [1-4] 다음 빈칸에 알맞은 어휘를 넣으세요.}\par\medskip
\begin{kfBlankList}
...
\kfStartGrammar{문법 영역 — 글의 짜임 (처음-가운데-끝)}


\kfSecHeader{kfAreaGrammar}{개념}{글의 짜임 (처음-가운데-끝)}
...
\kfSecHeader{kfAreaGrammar}{활동}{글의 짜임과 띄어쓰기}
\noindent\textit{\small 지시어가 가리키는 대상을 찾아 답해 보세요.}\par\medskip
\begin{enumerate}[leftmargin=22pt, itemsep=6pt, topsep=4pt, label=\textbf{\arabic*.}]
...
\kfSecHeader{kfAreaGrammar}{활동}{글의 짜임 (처음-가운데-끝)}
\noindent\textit{\small [1-3] 다음 내용이 글의 어느 부분에 들어갈지 선으로 연결해 보세요.}\par\medskip
\begin{kfConnect}
...
\kfSecHeader{kfAreaGrammar}{활동}{띄어쓰기 연습}
\noindent\textit{\small [1-2] 띄어쓰기를 잘못하면 뜻이 완전히 달라질 수 있습니다. 문장의 뜻이 잘 통하도록 띄어쓰기를 바르게 고쳐 써 보세요.}\par\medskip
\begin{enumerate}[leftmargin=22pt, itemsep=6pt, topsep=4pt, label=\textbf{\arabic*.}]
...
\kfStartConcept{개념 영역 — 글쓰기에도 지도가 필요해!}


\kfSecHeader{kfAreaConcept}{개념}{글쓰기에도 지도가 필요해!}
...
\kfSecHeader{kfAreaConcept}{활동}{글쓰기에도 지도가 필요해!}
\noindent\textit{\small [1-3] 위 글의 내용과 일치하면 O, 일치하지 않으면 X 표시를 하세요.}\par\medskip
\begin{kfOXList}
...
\kfSecHeader{kfAreaLiterature}{활동}{이야기 내용 파악하기}
\noindent\textit{\small [1-3] 이야기의 내용과 일치하면 O, 일치하지 않으면 X 표시를 하세요.}\par\medskip
\begin{kfOXList}
...
\kfSecHeader{kfAreaLiterature}{활동}{창의 활동: 나만의 글 설계도 그리기}
\noindent\textit{\small [1-3] 여러분이 '주말에 있었던 일'을 주제로 글을 쓴다면 어떤 설계도를 그릴지 상상해 보세요. 간단히 내용을 채워보세요.}\par\medskip
...
\kfSecHeader{kfAreaLiterature}{활동}{생각 나누기: 계획의 힘}
\noindent\textit{\small 다음 조건에 맞게 글을 써 보세요.}\par\medskip
...
\kfStartNonlit{비문학 영역 — 개요를 작성하는 방법과 중요성}


\kfSecHeader{kfAreaNonlit}{지문}{개요를 작성하는 방법과 중요성}
...
\kfSecHeader{kfAreaNonlit}{활동}{실천 활동: 개요 짜기 연습}
\noindent\textit{\small [1-3] 여러분이 '가장 좋아하는 음식'을 소개하는 글을 쓴다고 생각하고 개요를 완성해 보세요.}\par\medskip
\kfWritingPrompt{처음:}
\kfWriting{답안 작성}{8}
\kfWritingPrompt{가운데:}
\kfWriting{답안 작성}{8}
...
\end{kfQBlock}
\begin{kfQBlock}{2}{}
\kfQStem{개요를 작성했을 때의 장점이 \uline{아닌} 것은?}
\begin{kfChoices}
...
\begin{kfQBlock}{8}{}
\kfQStem{위 글에서 설명하는 '가운데' 부분에 들어갈 내용으로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
...
\kfStartVocab{어휘 영역 — 요약과 설명 관련 핵심 어휘}
...
\kfSecHeader{kfAreaVocab}{활동}{요약과 설명 관련 핵심 어휘}
\noindent\textit{\small [1-4] 다음 빈칸에 알맞은 어휘를 넣으세요.}\par\medskip
\begin{kfBlankList}
...
\kfStartGrammar{문법 영역 — 문장을 이어 주는 말 '접속사 (1)'}


\kfSecHeader{kfAreaGrammar}{개념}{문장을 이어 주는 말 '접속사 (1)'}
...
\kfSecHeader{kfAreaGrammar}{활동}{접속사와 요약의 기초}
\noindent\textit{\small 지시어가 가리키는 대상을 찾아 답해 보세요.}\par\medskip
\begin{enumerate}[leftmargin=22pt, itemsep=6pt, topsep=4pt, label=\textbf{\arabic*.}]
...
\kfSecHeader{kfAreaGrammar}{활동}{문장을 이어 주는 말 '접속사 (1)'}
\noindent\textit{\small [1-4] 다음 빈칸에 알맞은 접속사를 넣어 문장을 완성하세요. (그리고, 그러나, 그래서)}\par\medskip
\begin{kfBlankList}
\kfBlankItem 나는 사과를 좋아한다. ( ) 배도 좋아한다.
\kfBlankItem 어제는 비가 많이 왔다. ( ) 우리는 축구를 하지 못했다.
\kfBlankItem 열심히 공부했다. ( ) 시험 성적은 좋지 않았다.
\kfBlankItem 민호는 일기를 썼다. ( ) 잠자리에 들었다.
\end{kfBlankList}

\kfSecHeader{kfAreaGrammar}{활동}{중복된 표현 줄이기 (요약의 기초)}
\noindent\textit{\small [1-2] 같은 뜻을 가진 말이 반복되면 문장이 어색하고 길어집니다. 불필요하게 반복된 부분을 찾아 한 번만 사용하여 자연스러운 문장으로 고쳐 보세요.}\par\medskip
\begin{enumerate}[leftmargin=22pt, itemsep=6pt, topsep=4pt, label=\textbf{\arabic*.}]
...
\kfStartConcept{개념 영역 — 긴 글을 한 입 크기로! '요약'의 힘}


\kfSecHeader{kfAreaConcept}{개념}{긴 글을 한 입 크기로! '요약'의 힘}
...
\kfSecHeader{kfAreaConcept}{활동}{긴 글을 한 입 크기로! '요약'의 힘}
\noindent\textit{\small [1-3] 위 글의 내용과 일치하면 O, 일치하지 않으면 X 표시를 하세요.}\par\medskip
\begin{kfOXList}
...
\kfSecHeader{kfAreaLiterature}{활동}{창의 활동: 나의 경험 요약하기}
\noindent\textit{\small [1-2] 민호처럼 친구에게 해주고 싶은 재미있는 경험이 있나요? 처음에는 생각나는 대로 다 적어보고, 그중에서 불필요한 부분은 지우고 핵심만 남겨보세요.}\par\medskip
\kfWritingPrompt{원래 하고 싶은 말 (길게):}
\kfWriting{답안 작성}{8}
\kfWritingPrompt{요약한 말 (핵심만):}
\kfWriting{답안 작성}{8}

\kfSecHeader{kfAreaLiterature}{활동}{생각 나누기: 요약의 중요성}
\noindent\textit{\small [1-1] 민호의 경험을 참고하여, 중요한 내용을 요약하여 말하거나 글을 쓸 때 얻을 수 있는 긍정적인 효과를 두 가지 이상 써 보세요.}\par\medskip
...
\kfStartNonlit{비문학 영역 — 문단별 중심 내용을 요약하는 기술}


\kfSecHeader{kfAreaNonlit}{지문}{문단별 중심 내용을 요약하는 기술}
...
\kfSecHeader{kfAreaNonlit}{활동}{실천 활동: 요약 연습하기}
\noindent\textit{\small [1-1] 다음 문단을 읽고 불필요한 부분은 줄을 그어 지우고, 핵심 내용만 남겨 한 문장으로 요약해 보세요. "나는 어제 도서관에 가서 책을 빌렸다. 도서관에는 재미있는 만화책도 있었고, 공룡에 대한 책도 있었고, 위인전도 있었다. 나는 그중에서 평소에 읽고 싶었던 이순신 장군에 대한 위인전을 한 권 빌려서 집으로 돌아왔다."}\par\medskip
...
\end{kfQBlock}
\begin{kfQBlock}{2}{}
\kfQStem{글쓴이가 제시한 요약의 방법이 \uline{아닌} 것은?}
\begin{kfChoices}
...
\begin{kfEvidence}<보기>   "여름철에는 음식이 쉽게 상할 수 있습니다. 높은 온도와 습도 때문에 세균이 빨리 번식하기 때문입니다. 따라서 남은 음식은 반드시 냉장고에 보관해야 하고, 유통기한을 꼼꼼히 확인하는 것이 좋습니다."\end{kfEvidence}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{2}{}
\kfQStem{요약하는 과정에서 '불필요한 내용 생략'에 대한 설명으로 알맞지 \uline{않은} 것은?}
\begin{kfChoices}
...
\begin{kfQBlock}{11}{}
\kfQStem{다음 중 접속사에 대한 설명으로 알맞지 \uline{않은} 것은?}
\begin{kfChoices}
...
\begin{kfEvidence}비가 많이 왔다. [　　　　　] 소풍이 취소되었다. 늦잠을 잤다. [　　　　　] 지각을 하고 말았다.\end{kfEvidence}
\begin{kfChoices}
\kfChoice 하지만
\kfChoice 그러나
\kfChoice 그래서
...
\kfStartVocab{어휘 영역 — 날씨와 과학 관련 핵심 어휘}
...
\kfSecHeader{kfAreaVocab}{활동}{날씨와 과학 관련 핵심 어휘}
\noindent\textit{\small [1-4] 다음 빈칸에 알맞은 어휘를 넣으세요.}\par\medskip
\begin{kfBlankList}
...
\kfStartGrammar{문법 영역 — 문장을 이어 주는 말 '접속사 (2)'}


\kfSecHeader{kfAreaGrammar}{개념}{문장을 이어 주는 말 '접속사 (2)'}
...
\kfSecHeader{kfAreaGrammar}{활동}{접속사와 맞춤법}
\noindent\textit{\small 지시어가 가리키는 대상을 찾아 답해 보세요.}\par\medskip
\begin{enumerate}[leftmargin=22pt, itemsep=6pt, topsep=4pt, label=\textbf{\arabic*.}]
...
\kfSecHeader{kfAreaGrammar}{활동}{문장을 이어 주는 말 '접속사 (2)'}
\noindent\textit{\small [1-4] 다음 빈칸에 알맞은 접속사를 넣어 문장을 완성하세요. (왜냐하면, 따라서, 또는, 반면에)}\par\medskip
\begin{kfBlankList}
\kfBlankItem 여름에는 덥고 비가 많이 온다. ( ) 겨울에는 춥고 건조하다.
\kfBlankItem 영수는 이번 추석 때 기차 ( ) 고속버스로 시골에 내려갈 예정이다.
\kfBlankItem 기상청에서 태풍 경보를 내렸다. ( ) 배들은 항구로 돌아와야 했다.
\kfBlankItem 개미는 쉴 수가 없었다. ( ) 곧 겨울이 닥칠 것을 알았기 때문이다.
\end{kfBlankList}

\kfSecHeader{kfAreaGrammar}{활동}{틀리기 쉬운 맞춤법 구별하기}
\noindent\textit{\small [1-3] 문장의 뜻에 알맞은 낱말을 골라 ○표 하세요.}\par\medskip
\begin{enumerate}[leftmargin=22pt, itemsep=6pt, topsep=4pt, label=\textbf{\arabic*.}]
...
\kfStartConcept{개념 영역 — 내일 날씨는 어떻게 알 수 있을까?}


\kfSecHeader{kfAreaConcept}{개념}{내일 날씨는 어떻게 알 수 있을까?}
...
\kfSecHeader{kfAreaConcept}{활동}{내일 날씨는 어떻게 알 수 있을까?}
\noindent\textit{\small [1-3] 위 글의 내용과 일치하면 O, 일치하지 않으면 X 표시를 하세요.}\par\medskip
\begin{kfOXList}
...
\kfStartNonlit{비문학 영역 — 일기 예보는 어떻게 만들어질까요?}


\kfSecHeader{kfAreaNonlit}{지문}{일기 예보는 어떻게 만들어질까요?}
...
\kfSecHeader{kfAreaNonlit}{활동}{실천 활동: 일기 예보관 되어보기}
\noindent\textit{\small 다음 관측 자료를 보고 내일의 날씨를 예측하여 방송 원고를 완성해 보세요.}\par\medskip
\begin{kfBlankList}
\kfBlankItem [관측 자료] * 구름: 서쪽에서 먹구름이 빠르게 몰려오고 있음. * 바람: 바람이 점점 강하게 불고 있음. * 기온: 내일 아침 기온이 오늘보다 5도 정도 떨어질 것으로 보임.

[방송 원고] "내일 날씨를 알려드립니다. 서쪽에서 ( )이 몰려오고 있어 비가 내릴 것으로 보입니다. ( )도 강하게 불고 기온이 떨어져 날씨가 ( )지겠으니, 따뜻한 옷차림을 하시는 것이 좋겠습니다."
\end{kfBlankList}
...
\end{kfQBlock}
\begin{kfQBlock}{1}{}
\kfQStem{다음 중 '관측' 단계에서 하는 일이 \uline{아닌} 것은?}
\begin{kfChoices}
...
\begin{kfQBlock}{9}{}
\kfQStem{일기 예보의 첫 번째 단계인 '관측'에서 하는 일이 \uline{아닌} 것은?}
\begin{kfChoices}
...
\begin{kfEvidence}"먹구름이 끼더니 [　　　　　] 비가 쏟아졌습니다." (지금 바로, 짧은 시간에라는 뜻)\end{kfEvidence}
\begin{kfChoices}
\kfChoice 금새
\kfChoice 금세
\kfChoice 틈새

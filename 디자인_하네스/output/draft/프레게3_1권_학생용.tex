...
\kfChapterAreaItem{개념}{kfAreaConcept}{다른 것에 빗대어 표현하기}
\kfChapterAreaItem{문학}{kfAreaLiterature}{「나는 이제 너에게도 슬픔을 주겠다.」}
\kfChapterAreaItem{비문학}{kfAreaNonlit}{[인문] 사람은 본래 착할까, 나쁠까?}
\end{kfChapterAreaList}

\kfStartConcept{다른 것에 빗대어 표현하기}
...
\kfQStem{다음 중, 사람이 \underline{아닌} 것을 사람처럼 표현한 의인법이 사용된 것은 무엇인가요?}
\begin{kfChoices}
...
\kfQStem{김동명의 시 「내 마음은」에 나오는 “내 마음은 호수요”라는 표현에 대한 설명으로 적절하지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
...
\kfQStem{비유법에 대한 설명으로 알맞지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
...
\kfQStem{다음 시 구절과 그에 사용된 비유법의 연결이 알맞지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
...
\kfQStem{"풀이 눕는다"처럼, 사람이 \underline{아닌} 것을 사람처럼 표현하여 친근하게 만드는 방법을 무엇이라고 하나요?}
\kfAnswerLines{1}
\end{kfQBlock}
...
\par\kfMaybeNeedspace{32\baselineskip}\noindent{\kfTipMark\,\,}{\small\color{kfInk} 다음 문장을 읽고 물음에 답하시오.}\par\nopagebreak[4]\smallskip\nopagebreak[4]
\kfBeginMC
...
\end{kfQBlock}
\begin{kfQBlock}{08}{객관식}
\kfQStem{이 시에 대한 설명으로 알맞지 \uline{\underline{않은}} 것은 무엇일까요?}
\begin{kfChoices}
...
\kfStartNonlit{[인문] 사람은 본래 착할까, 나쁠까?}
...
\end{kfQBlock}
\begin{kfQBlock}{04}{객관식}
\kfQStem{다음 <보기>의 상황을 지문의 관점으로 분석할 때, 적절하지 \uline{\underline{않은}} 것은 무엇인가요?}
...
\begin{kfEvidence}㉠ 성선설 \\\relax
㉡ 성악설 \\\relax
㉢ 성무선악설\end{kfEvidence}
\begin{kfChoices}
...
철수: 맞아. 고자라는 학자도 사람의 본성은 [ \\\relax
㉠    ]과 같다고 했어.\end{kfEvidence}
\begin{kfChoices}
\kfChoice 악한 마음
\kfChoice 착한 본성
\kfChoice 자연스러운 욕구
...
\begin{kfChapterAreaList}
\kfChapterAreaItem{문법}{kfAreaGrammar}{분석\_훈련}
\kfChapterAreaItem{문학}{kfAreaLiterature}{「우리 집에는 낡고 오래된 행랑채가 있습니…」}
\kfChapterAreaItem{비문학}{kfAreaNonlit}{[사회] 비싸지면 안 사? 꼭 그렇지는 않아!}
\end{kfChapterAreaList}

\kfStartGrammar{분석\_훈련}
...
\kfBeginMC
\begin{kfQBlock}{01}{객관식}
\kfQStem{다음 중 품사의 종류가 \underline{다른 하나}는 무엇인가요?}
\begin{kfChoices}
\kfChoice 하늘
\kfChoice 사랑
\kfChoice 컴퓨터
...
\end{kfQBlock}
\begin{kfQBlock}{04}{객관식}
\kfQStem{다음 중 조사가 사용되지 \uline{\underline{않은}} 문장은 무엇인가요?}
\begin{kfChoices}
\kfChoice 하늘이 푸르다.
\kfChoice 매우 빠르다.
\kfChoice 아기가 웃는다.
...
\end{kfQBlock}
\begin{kfQBlock}{05}{객관식}
\kfQStem{다음 중 홀로 쓰일 수 \uline{\underline{없는}} 품사는 무엇인가요?}
\begin{kfChoices}
\kfChoice 명사
\kfChoice 동사
\kfChoice 부사
...
\kfStartLit{「우리 집에는 낡고 오래된 행랑채가 있습니…」}
...
\end{kfQBlock}
\begin{kfQBlock}{04}{객관식}
\kfQStem{글쓴이의 경험에 대한 설명으로 알맞지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
...
\kfStartNonlit{[사회] 비싸지면 안 사? 꼭 그렇지는 않아!}
...
\end{kfQBlock}
\begin{kfQBlock}{02}{객관식}
\kfQStem{윗글을 바탕으로 <보기>의 A, B 상품을 이해한 내용으로 적절하지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfEvidence}A상품: 가격이 5\% 오르자, 사려는 사람이 1\% 줄었다. \\\relax
B상품: 가격이 5\% 오르자, 사려는 사람이 10\% 줄었다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfEvidence}| 종류 | 가격 변화 | 판매량(사려는 양) 변화 | \\\relax
| :---- | :---- | :---- | \\\relax
| 우유 식빵 | 10\% 오름 | 2\% 줄어듦 | \\\relax
| 딸기 케이크 | 10\% 오름 | 30\% 줄어듦 |\end{kfEvidence}
\begin{kfChoices}
\kfChoice 식빵은 탄력적이다.
\kfChoice 케이크는 탄력적이다.
...
\begin{kfChapterAreaList}
\kfChapterAreaItem{개념}{kfAreaConcept}{다섯 가지 감각으로 느끼는 심상}
\kfChapterAreaItem{문학}{kfAreaLiterature}{「높은 가지를 흔드는 매미 소리에 묻혀」}
\kfChapterAreaItem{비문학}{kfAreaNonlit}{[과학] 제로 칼로리 식품의 비밀}
\end{kfChapterAreaList}

\kfStartConcept{다섯 가지 감각으로 느끼는 심상}
...
\end{kfQBlock}
\begin{kfQBlock}{07}{객관식}
\kfQStem{심상에 대한 설명으로 알맞지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{09}{객관식}
\kfQStem{다음 <보기>에 사용된 심상에 대한 설명으로 적절하지 \uline{\underline{않은}} 것은 무엇인가요?}
...
\kfStartLit{「높은 가지를 흔드는 매미 소리에 묻혀」}
...
\end{kfQBlock}
\begin{kfQBlock}{05}{객관식}
\kfQStem{힘든 상황 속에서도 드러나는 말하는 이의 태도로 적절하지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{08}{객관식}
\kfQStem{이 시의 전체 주제에 대한 설명으로 적절하지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
...
\kfStartNonlit{[과학] 제로 칼로리 식품의 비밀}
...
\end{kfQBlock}
\begin{kfQBlock}{03}{객관식}
\kfQStem{우리나라에서 식품에 '0칼로리'라고 표시하기 위한 기준에 대한 설명으로 적절하지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{04}{객관식}
\kfQStem{윗글에서 설명하는 '제로 칼로리 식품'에 대한 설명으로 적절하지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
...
\begin{kfEvidence}철수: "나 요즘 다이어트하려고 제로 콜라만 마시고 있어." \\\relax
영희: "그래? 그럼 단걸 덜 먹게 되니?" \\\relax
철수: "아니, 이상하게 귤이나 사과를 먹으면 예전만큼 달게 느껴지지가 않아. 그래서 자꾸 더 달콤한 사탕이나 초콜릿이 먹고 싶어져."\end{kfEvidence}
\begin{kfChoices}
\kfChoice 배가 부른 상태다.
...
\end{kfQBlock}
\begin{kfQBlock}{08}{객관식}
\kfQStem{전문가들이 제로 칼로리 식품을 먹을 때 주의하라고 경고하는 이유로 적절하지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
...
\begin{kfChapterAreaList}
\kfChapterAreaItem{문법}{kfAreaGrammar}{분석\_훈련}
\kfChapterAreaItem{문학}{kfAreaLiterature}{「처음에 북부여 왕 해부루가 동부여로 자리…」}
\kfChapterAreaItem{비문학}{kfAreaNonlit}{[기술] 조상들의 지혜, 천연 냉장고 석빙고}
\end{kfChapterAreaList}
...
\end{kfQBlock}
\begin{kfQBlock}{04}{객관식}
\kfQStem{조사에 대한 설명으로 바르지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
\kfChoice 홀로 쓰일 수 없다.
...
\kfStartLit{「처음에 북부여 왕 해부루가 동부여로 자리…」}
...
\end{kfQBlock}
\begin{kfQBlock}{05}{객관식}
\kfQStem{부여를 탈출하던 주몽이 다리 \underline{없는} 강을 건널 수 있었던 이유는 무엇인가요?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{07}{객관식}
\kfQStem{주몽이 알의 상태로 버려졌을 때, 알을 보호해 준 존재가 \uline{\underline{아닌}} 것은 무엇인가요?}
\begin{kfChoices}
\kfChoice 자라
\kfChoice 소
\kfChoice 새
...
\kfStartNonlit{[기술] 조상들의 지혜, 천연 냉장고 석빙고}
...
\kfBeginMC
\begin{kfQBlock}{01}{객관식}
\kfQStem{다음 중 석빙고에서 얼음이 오래 보관될 수 있는 원리로 가장 적절하지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{03}{객관식}
\kfQStem{'짚'의 역할로 적절하지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}

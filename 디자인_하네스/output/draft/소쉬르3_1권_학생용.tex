...
\vspace*{40mm}
\begin{center}
{\Huge\bfseries\color{kfPrimary} 소쉬르3}\\[10pt]
...
\kfStartVocab{어휘 영역 — 나를 표현하는 말들}


\kfSecHeader{kfAreaVocab}{어휘}{나를 표현하는 말들}
...
\kfStartConcept{개념 영역 — 나를 표현하는 말들}


\kfSecHeader{kfAreaConcept}{활동}{나를 표현하는 말들}
\noindent\textit{\small 다음 빈칸에 어울리는 어휘를 적어 보세요.}\par\medskip
\begin{kfBlankList}
\kfBlankItem 나는 거울을 보며 나의 (          )을 깊이 들여다보았다.   

(마음속이나 정신의 안쪽을 가리키는 말)
\kfBlankItem 친구의 조언을 듣고 나의 행동을 (          )하는 시간을 가졌다.   

(자신을 깊이 살펴보고 반성하는 것)
\end{kfBlankList}

\kfSecHeader{kfAreaConcept}{개념}{배경지식 넓히기: 자아 성찰의 중요성}
...
\kfSecHeader{kfAreaConcept}{활동}{배경지식 넓히기: 자아 성찰의 중요성}
\noindent\textit{\small 다음 설명이 맞으면 ○, 틀리면 ×를 표시해 보세요.}\par\medskip
\begin{kfOXList}
...
\kfSecHeader{kfAreaConcept}{개념}{중심 문장과 뒷받침 문장 (1)}
...
\begin{kfEvidence}① 좋은 친구는 우리 삶에 꼭 필요한 존재입니다.   ② 힘들 때 위로해주고 격려해줍니다.   ③ 기쁜 일이 있을 때 함께 기뻐해줍니다.  ④ 또한 잘못된 길로 가려 할 때 바른 길을 알려줍니다.\end{kfEvidence}
\begin{kfChoices}
\kfChoice ① 번 문장
\kfChoice ② 번 문장
\kfChoice ③ 번 문장
...
\begin{kfQBlock}{2}{}
\kfQStem{\textbackslash{}<보기\textbackslash{}>에서 중심 문장은 몇 번 문장인가요?}
\begin{kfEvidence}① 물은 우리 몸의 노폐물을 밖으로 내보내 줍니다.   ② 또한 체온을 조절하는 중요한 역할도 합니다.   ③ 피부를 촉촉하게 유지하는 데도 도움이 됩니다.  ④ 따라서 우리는 물을 자주 마셔야 합니다.\end{kfEvidence}
\begin{kfChoices}
\kfChoice ① 번 문장
\kfChoice ② 번 문장
\kfChoice ③ 번 문장
...
\kfSecHeader{kfAreaLiterature}{활동}{창의 활동: 나만의 시 쓰기}
\noindent\textit{\small 주어진 안내에 맞춰 자유롭게 글로 표현해 보세요.}\par\medskip
\kfWritingPrompt{'거울 속의 나'를 읽고, 여러분도 자신을 돌아보는 짧은 시를 써보세요. 아래의 형식을 참고하여 4행 정도로 작성해보세요.}
\kfWriting{답안 작성}{8}

\kfSecHeader{kfAreaLiterature}{글쓰기}{창의 활동: 나만의 시 쓰기}

\kfWritingPrompt{[\{"번호":7,"문제":"'거울 속의 나'를 읽고, 여러분도 자신을 돌아보는 짧은 시를 써보세요. 아래의 형식을 참고하여 4행 정도로 작성해보세요."\}]}
\kfWriting{글쓰기 답안}{12}


\kfStartNonlit{비문학 영역 — 나의 장점과 단점}


\kfSecHeader{kfAreaNonlit}{지문}{나의 장점과 단점}
...
\kfSecHeader{kfAreaNonlit}{활동}{문장 독해 훈련}
\noindent\textit{\small 각 문장을 읽고 물음에 답하세요.}\par\medskip
...
\kfSecHeader{kfAreaNonlit}{활동}{지시어 확인}
\noindent\textit{\small 다음 문장에서 지시어가 가리키는 대상을 찾으세요.}\par\medskip
...
\end{kfQBlock}
\begin{kfQBlock}{6}{}
\kfQStem{글쓴이가 제시한 '자신을 객관적으로 보기 어려운 이유'로 적절하지 \uline{않은} 것은?}
\begin{kfChoices}
...
\kfSecHeader{kfAreaNonlit}{활동}{글의 내용 파악하기}
\noindent\textit{\small 빈칸에 알맞은 말을 채워 보세요.}\par\medskip
\begin{kfBlankList}
\kfBlankItem 요약문 완성하기: 각 문단의 중심 내용을 잘 읽고, 빈칸에 들어갈 알맞은 말을 지문에서 찾아 쓰세요.

1문단: 사람은 누구나 남들보다 뛰어난 (        )과/와 고쳐야 할 (        )을/를 가지고 있다. 2문단: 우리는 감정 때문에 스스로를 (        )으로 보기 어렵다. 3문단: 다른 사람과 (        )하는 습관은 나의 진짜 능력을 알기 어렵게 만든다. 4문단: 자신이 좋아하고 (        ) 하는 일을 생각해보면 장점을 찾을 수 있다. 5문단: 단점을 (        )하지 말고 더 나은 사람이 되기 위해 노력해야 한다.
\end{kfBlankList}
...
\end{kfQBlock}
\begin{kfQBlock}{9}{}
\kfQStem{글쓴이는 "진정한 장점과 단점은 남과의 비교가 아닌, 자신의 다른 능력들과 비교해서 찾아야 합니다"라고 했습니다. 이 말의 의미를 구체적인 예를 들어 설명하시오.}
\kfAnswerNote{답안}{4}
\end{kfQBlock}

\kfSecHeader{kfAreaNonlit}{활동}{창의 활동: 나의 장점과 단점 찾기}
\noindent\textit{\small 주어진 안내에 맞춰 자유롭게 글로 표현해 보세요.}\par\medskip
\kfWritingPrompt{지문에서 배운 방법을 활용하여 나의 장점 한 가지와 단점 한 가지를 찾아보고, 왜 그렇게 생각하는지 구체적인 이유와 함께 글로 써 보세요.}
\kfWriting{답안 작성}{8}

\kfSecHeader{kfAreaNonlit}{글쓰기}{창의 활동: 나의 장점과 단점 찾기}

\kfWritingPrompt{[\{"번호":10,"문제":"지문에서 배운 방법을 활용하여 나의 장점 한 가지와 단점 한 가지를 찾아보고, 왜 그렇게 생각하는지 구체적인 이유와 함께 글로 써 보세요."\}]}
\kfWriting{글쓰기 답안}{12}


\kfStartWeekly{실력확인 영역 — 주간 종합 평가}
...
\begin{kfEvidence}"거울은 우리의 겉모습을 비추지만, 자아 성찰은 마음속 깊은 곳인 (     )을/를 들여다보게 합니다."\end{kfEvidence}
\begin{kfChoices}
\kfChoice 외면
\kfChoice 내면
\kfChoice 앞면
...
\begin{kfQBlock}{6}{}
\kfQStem{위 글에서 자신의 장단점을 찾는 방법으로 제시되지 \uline{않은} 것은?}
\begin{kfChoices}
...
\begin{kfEvidence}㉠ 독서는 우리에게 꼭 필요합니다. ㉡ 독서는 상상력을 키워 줍니다. ㉢ 독서는 다양한 지식을 얻게 해 줍니다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfEvidence}거울은 우리의 (       )을/를 비추지만, 자아 성찰은 우리의 (       )을/를 들여다보게 한다.\end{kfEvidence}
\begin{kfChoices}
...
\kfStartVocab{어휘 영역 — 마음을 표현하는 말들}


\kfSecHeader{kfAreaVocab}{어휘}{마음을 표현하는 말들}
...
\kfStartConcept{개념 영역 — 마음을 표현하는 말들}


\kfSecHeader{kfAreaConcept}{활동}{마음을 표현하는 말들}
\noindent\textit{\small 다음 빈칸에 어울리는 어휘를 적어 보세요.}\par\medskip
\begin{kfBlankList}
\kfBlankItem 배가 아픈 (           )을 찾아보니, 찬 음식을 너무 많이 먹어서였다.   (어떤 일이 일어나게 된 까닭)
\kfBlankItem 동생에게 화를 낸 뒤에, 나는 곧 나의 행동을 (           )했다.   (자신의 일을 잘못된 것으로 느껴 뉘우침)
\end{kfBlankList}

\kfSecHeader{kfAreaConcept}{개념}{배경지식 넓히기: 모든 일에는 이유가 있어요}
...
\kfSecHeader{kfAreaConcept}{활동}{배경지식 넓히기: 모든 일에는 이유가 있어요}
\noindent\textit{\small 다음 설명이 맞으면 ○, 틀리면 ×를 표시해 보세요.}\par\medskip
\begin{kfOXList}
...
\kfSecHeader{kfAreaConcept}{개념}{원인과 결과(인과 관계)}
...
\kfSecHeader{kfAreaLiterature}{활동}{창의 활동: 나만의 감정 조절법 만들기}
\noindent\textit{\small 주어진 안내에 맞춰 자유롭게 글로 표현해 보세요.}\par\medskip
\kfWritingPrompt{사자는 화가 날 때 '숫자 세기'를 하기로 했습니다. 여러분은 화가 나거나 속상할 때 어떻게 기분을 풀나요? 나만의 방법을 소개해 주세요.}
\kfWriting{답안 작성}{8}

\kfSecHeader{kfAreaLiterature}{글쓰기}{창의 활동: 나만의 감정 조절법 만들기}

\kfWritingPrompt{[\{"번호":6,"문제":"사자는 화가 날 때 '숫자 세기'를 하기로 했습니다. 여러분은 화가 나거나 속상할 때 어떻게 기분을 풀나요? 나만의 방법을 소개해 주세요."\}]}
\kfWriting{글쓰기 답안}{12}


\kfStartNonlit{비문학 영역 — 감정이 우리에게 보내는 신호}


\kfSecHeader{kfAreaNonlit}{지문}{감정이 우리에게 보내는 신호}
...
1문단: 감정은 우리 몸과 마음이 보내는 중요한 (        )이다. 2문단: '화'는 나의 소중한 것을 (        )해야 한다는 뜻이다. 3문단: '슬픔'은 (        )가 필요하다는 신호이다. 4문단: '두려움'은 (        )을 피하라고 우리 몸이 보내는 경고이다. 5문단: (        ) 감정은 하나도 없으니, 감정의 소리를 잘 들어야 한다.
\end{kfBlankList}

\kfSecHeader{kfAreaNonlit}{문제}{}

\begin{kfQBlock}{9}{}
\kfQStem{글쓴이는 "쓸모없는 감정은 하나도 없습니다"라고 말했습니다. 내가 느끼기 싫은 '짜증'이나 '부끄러움' 같은 감정도 필요한 이유가 무엇일지 생각해서 적어보세요.}
\kfAnswerNote{답안}{4}
\end{kfQBlock}
\begin{kfQBlock}{10}{}
...
\kfSecHeader{kfAreaNonlit}{활동}{창의 활동: 나의 감정 신호등}
\noindent\textit{\small 주어진 안내에 맞춰 자유롭게 글로 표현해 보세요.}\par\medskip
\kfWritingPrompt{최근에 느꼈던 강한 감정 하나를 골라, 그 감정이 나에게 어떤 신호를 보냈는지 적어보세요.}
\kfWriting{답안 작성}{8}

\kfSecHeader{kfAreaNonlit}{글쓰기}{창의 활동: 나의 감정 신호등}

\kfWritingPrompt{[\{"번호":11,"문제":"최근에 느꼈던 강한 감정 하나를 골라, 그 감정이 나에게 어떤 신호를 보냈는지 적어보세요."\}]}
\kfWriting{글쓰기 답안}{12}

\kfSecHeader{kfAreaNonlit}{활동}{글의 내용 파악하기}
\noindent\textit{\small 다음 활동을 풀어 보세요.}\par\medskip
...
\kfStartVocab{어휘 영역 — 대화를 돕는 말들}


\kfSecHeader{kfAreaVocab}{어휘}{대화를 돕는 말들}
...
\kfStartGrammar{문법 영역 — 문장의 짜임}


\kfSecHeader{kfAreaGrammar}{개념}{문장의 짜임}
...
\kfSecHeader{kfAreaGrammar}{활동}{문장의 짜임}
\noindent\textit{\small 다음 문장이 어떤 짜임인지 찾아 선으로 연결해 보세요.}\par\medskip
\begin{kfConnect}
...
\kfStartConcept{개념 영역 — 대화를 돕는 말들}


\kfSecHeader{kfAreaConcept}{활동}{대화를 돕는 말들}
\noindent\textit{\small 다음 빈칸에 어울리는 어휘를 적어 보세요.}\par\medskip
\begin{kfBlankList}
\kfBlankItem 친구의 고민을 들을 때는 딴짓을 하지 않고 (           )해야 한다.   (귀를 기울여 주의 깊게 듣는 것)
\kfBlankItem 내 말이 잘못 전달되어 친구와 작은 (           )가 생겼다.   (뜻을 잘못 알게 되는 것)
\end{kfBlankList}

\kfSecHeader{kfAreaConcept}{개념}{배경지식 넓히기: 마음을 여는 열쇠, 공감}
...
\kfSecHeader{kfAreaConcept}{활동}{배경지식 넓히기: 마음을 여는 열쇠, 공감}
\noindent\textit{\small 다음 설명이 맞으면 ○, 틀리면 ×를 표시해 보세요.}\par\medskip
\begin{kfOXList}
...
\kfSecHeader{kfAreaConcept}{개념}{중심 문장과 뒷받침 문장 (2)}
...
\begin{kfQBlock}{1}{}
\kfQStem{\textbackslash{}<보기\textbackslash{}>에서 중심 문장은 몇 번 문장인가요?}
\begin{kfEvidence}① 건강을 지키기 위해 손 씻기는 매우 중요합니다.   ② 손에는 눈에 보이지 않는 세균이 많기 때문입니다.   ③ 외출 후에는 비누로 30초 이상 손을 씻어야 합니다.  ④ 밥을 먹기 전에도 깨끗이 씻는 것이 좋습니다.\end{kfEvidence}
\begin{kfChoices}
\kfChoice ① 번 문장
\kfChoice ② 번 문장
\kfChoice ③ 번 문장
...
\begin{kfQBlock}{2}{}
\kfQStem{\textbackslash{}<보기\textbackslash{}>에서 중심 문장은 몇 번 문장인가요?}
\begin{kfEvidence}① 횡단보도를 건널 때는 좌우를 잘 살펴야 합니다.   ② 신호등이 초록불로 바뀌어도 바로 뛰지 말아야 합니다.   ③ 길을 건너는 도중에는 장난을 치지 않습니다.  ④ 이처럼 우리는 교통안전 수칙을 잘 지켜야 합니다.\end{kfEvidence}
\begin{kfChoices}
\kfChoice ① 번 문장
\kfChoice ② 번 문장
\kfChoice ③ 번 문장
...
\kfSecHeader{kfAreaLiterature}{활동}{창의 활동: 마음을 담아 다시 말하기}
\noindent\textit{\small 주어진 안내에 맞춰 자유롭게 글로 표현해 보세요.}\par\medskip
\kfWritingPrompt{만약 여러분이 이야기 속의 초록이라면, 울고 있는 다람쥐에게 처음부터 어떻게 말해 주었을까요? 위로하는 말을 상상해서 적어보세요.}
\kfWriting{답안 작성}{8}

\kfSecHeader{kfAreaLiterature}{글쓰기}{창의 활동: 마음을 담아 다시 말하기}

\kfWritingPrompt{[\{"번호":6,"문제":"만약 여러분이 이야기 속의 초록이라면, 울고 있는 다람쥐에게 처음부터 어떻게 말해 주었을까요? 위로하는 말을 상상해서 적어보세요."\}]}
\kfWriting{글쓰기 답안}{12}


\kfStartNonlit{비문학 영역 — 공감하며 대화하는 방법}


\kfSecHeader{kfAreaNonlit}{지문}{공감하며 대화하는 방법}
...
\end{kfQBlock}
\begin{kfQBlock}{5}{}
\kfQStem{이 글에서 '경청'을 하는 방법으로 든 것이 \uline{아닌} 것은 무엇인가요?}
\begin{kfChoices}
...
1문단: 대화는 두 사람이 함께 (        )을/를 주고받는 것이다. 2문단: 귀로만 듣지 말고 눈과 몸으로 듣는 (        )을/를 해야 한다. 3문단: 상대방의 말에 적절한 (        )을/를 보여 주어야 한다. 4문단: 상대방의 (        )을/를 읽어 주어야 마음의 문이 열린다. 5문단: 대화의 기술보다 더 중요한 것은 상대를 아끼는 (        )이다.
\end{kfBlankList}
...
\kfSecHeader{kfAreaNonlit}{활동}{창의 활동: 공감의 말 연습하기}
\noindent\textit{\small 주어진 안내에 맞춰 자유롭게 글로 표현해 보세요.}\par\medskip
\kfWritingPrompt{지문에서 배운 대화 방법을 활용하여, 친구가 속상해할 때 따뜻한 맞장구와 공감의 말로 위로했던 경험(또는 앞으로 어떻게 위로할지)을 2\textasciitilde{}3문장으로 자세히 적어보세요.}
\kfWriting{답안 작성}{8}

\kfSecHeader{kfAreaNonlit}{글쓰기}{창의 활동: 공감의 말 연습하기}

\kfWritingPrompt{[\{"번호":9,"문제":"지문에서 배운 대화 방법을 활용하여, 친구가 속상해할 때 따뜻한 맞장구와 공감의 말로 위로했던 경험(또는 앞으로 어떻게 위로할지)을 2\textasciitilde{}3문장으로 자세히 적어보세요."\}]}
\kfWriting{글쓰기 답안}{12}
...
\kfStartVocab{어휘 영역 — 생각의 깊이를 더하는 말들}


\kfSecHeader{kfAreaVocab}{어휘}{생각의 깊이를 더하는 말들}
...
\kfStartConcept{개념 영역 — 생각의 깊이를 더하는 말들}


\kfSecHeader{kfAreaConcept}{활동}{생각의 깊이를 더하는 말들}
\noindent\textit{\small 다음 빈칸에 어울리는 어휘를 적어 보세요.}\par\medskip
\begin{kfBlankList}
\kfBlankItem 친구와 다투었을 때는 서로의 (           )을 바꿔서 생각해 봐야 한다.   (처해 있는 형편)
\kfBlankItem 같은 그림이라도 보는 (           )에 따라 다르게 보일 수 있다.   (바라보는 방향이나 생각)
\end{kfBlankList}

\kfSecHeader{kfAreaConcept}{개념}{배경지식 넓히기: 내가 너라면 어떨까?}
...
\kfSecHeader{kfAreaConcept}{활동}{배경지식 넓히기: 내가 너라면 어떨까?}
\noindent\textit{\small 다음 설명이 맞으면 ○, 틀리면 ×를 표시해 보세요.}\par\medskip
\begin{kfOXList}
...
\kfSecHeader{kfAreaLiterature}{활동}{창의 활동: 역할 바꾸기 상황극}
\noindent\textit{\small 주어진 안내에 맞춰 자유롭게 글로 표현해 보세요.}\par\medskip
\kfWritingPrompt{이번에는 여러분이 선생님이 되고, 학생이 되어보는 상황을 상상해 보세요. 선생님이 된 여러분은 학생에게 어떤 말을 해주고 싶나요?}
\kfWriting{답안 작성}{8}

\kfSecHeader{kfAreaLiterature}{글쓰기}{창의 활동: 역할 바꾸기 상황극}

\kfWritingPrompt{[\{"번호":6,"문제":"이번에는 여러분이 선생님이 되고, 학생이 되어보는 상황을 상상해 보세요. 선생님이 된 여러분은 학생에게 어떤 말을 해주고 싶나요?"\}]}
\kfWriting{글쓰기 답안}{12}


\kfStartNonlit{비문학 영역 — 다른 사람의 입장에서 생각하기}


\kfSecHeader{kfAreaNonlit}{지문}{다른 사람의 입장에서 생각하기}
...
1문단: 내 (        )만 옳다고 고집하면 싸움이 일어난다. 2문단: 다툼을 줄이려면 상대방의 (        )이 되어 보아야 한다. 3문단: 첫 번째 방법은 "(        ) 어땠을까?"라고 스스로에게 물어보는 것이다. 4문단: 두 번째 방법은 상대방의 이야기를 (        ) 들어주는 것이다. 5문단: 입장을 바꾸어 생각하는 것은 상대방을 (        )하는 지혜로운 태도이다.
\end{kfBlankList}
...
\begin{kfEvidence}친구가 청소 당번인데 청소를 하지 않고 집에 가버렸습니다. 처음에는 화가 났지만, '마법의 안경'을 쓰고 친구의 입장을 상상해 보세요. * 내 생각(처음): "청소도 안 하고 가다니 정말 무책임해\textbackslash{}!" * 친구의 입장 상상하기:\end{kfEvidence}
\kfAnswerNote{답안}{4}
\end{kfQBlock}

\kfSecHeader{kfAreaNonlit}{활동}{창의 활동: 역지사지 연습하기}
\noindent\textit{\small 주어진 안내에 맞춰 자유롭게 글로 표현해 보세요.}\par\medskip
...
\kfSecHeader{kfAreaNonlit}{글쓰기}{창의 활동: 역지사지 연습하기}

\kfWritingPrompt{[\{"번호":10,"문제":"최근에 친구나 가족과 다투었거나 의견이 달랐던 경험을 떠올려 보세요. 그때 '마법의 안경'을 쓰고 상대방의 입장에서 생각했다면 상황이 어떻게 달라졌을지 2\textasciitilde{}3문장으로 자유롭게 글을 써보세요."\}]}
\kfWriting{글쓰기 답안}{12}
...
\begin{kfQBlock}{8}{}
\kfQStem{공식적인 상황에서 지켜야 할 예절로 알맞지 않은 것은 무엇인가요?}
\begin{kfChoices}
\kfChoice 존댓말을 사용한다.

...
\kfChapterAreaItem{문법}{kfAreaGrammar}{음운 / 음운의 체계 심화}
\kfChapterAreaItem{문학}{kfAreaLiterature}{「간」 — 윤동주 외 4편}
\kfChapterAreaItem{비문학}{kfAreaNonlit}{「하이데거의 존재와 시간」 외 4편}
\kfChapterAreaItem{실력 확인}{kfAreaWeekly}{패턴 워크북 — 총 ?문항}
\end{kfChapterAreaList}

\kfStartGrammar{음운 / 음운의 체계 심화}
...
\kfQStem{윗글을 바탕으로 <보기>의 ⓐ\textasciitilde{}ⓔ에 대해 탐구한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}ⓐ 잡아(잡- + -아)    ⓑ 써서(쓰- + -어서)    ⓒ 하여(하- + -여) \\\relax
ⓓ 놀아(놀- + -아)    ⓔ 담가(담그- + -아)\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfEvidence}「공장에서 만든 쌀빵이 참 맛있다.」 \\\relax
이 문장의 첫 번째 음절부터 마지막 음절까지에 나타나는 자음을 분석해 보자.\end{kfEvidence}
\begin{kfChoices}
...
\kfQStem{윗글을 바탕으로 할 때, <보기>에서 최소 대립쌍을 이루는 것끼리 짝지은 것으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}ㄱ. 달 — 탈 \\\relax
ㄴ. 밤 — 밥 \\\relax
ㄷ. 굴 — 귤 \\\relax
ㄹ. 벌 — 벽 \\\relax
ㅁ. 살 — 쌀\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfEvidence}(가) 현대 국어에서 많은 화자가 '개'와 '게'를 같은 발음으로 발음한다. \\\relax
(나) 'ㅚ'를 [외]로도, [웨]로도 발음할 수 있다. \\\relax
(다) 중세 국어의 '㗊'(아래아)은 현대 국어에서 주로 'ㅏ'나 'ㅡ'로 변화하였다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfEvidence}윤동주의 시에서 '바다'와 '하늘'은 화자가 도달하지 못하는 이상 세계를 상징하는 경우가 많다. 한편 화자는 현실의 '땅' 위에 머물면서 이상과 현실 사이의 괴리를 고뇌한다. 이 시가 쓰인 1941년은 태평양전쟁 직전으로, 조선인의 정체성이 극도로 위협받던 시기이다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{05}{객관식}
\kfQStem{윗시를 바탕으로 <보기>를 감상한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}윤동주의 시에서 '소년'은 아직 세계에 의해 오염되지 않은 순수한 자아를 상징하는 경우가 많다. 이 순수한 자아는 성장 과정에서 세계의 폭력성·불확실성과 만나면서 위기에 처하게 된다. 윤동주는 이러한 순수의 위기를 반복적으로 형상화함으로써 식민지 시대 지식인의 내면적 갈등을 보여준다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfEvidence}이성복의 시에서 자아와 세계는 화해하지 못한다. 세계가 아무리 아름다운 모습을 보여주어도, 자아는 그 아름다움 안에서 오히려 자신의 고독과 이질감을 더 강하게 의식한다. 이는 하이데거가 말한 '불안' — 일상적 세계의 의미 연관이 무너지고 존재 자체가 문제가 되는 근원적 기분 — 과 유사한 맥락에서 이해할 수 있다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfEvidence}오정희의 소설에서 사춘기 소녀는 세계를 감각적으로 경험하지만 그 의미를 개념적으로 이해하지 못한다. 이 간극이 독특한 서사적 긴장을 만든다. 소녀의 감각 경험은 단순한 배경 묘사가 아니라 존재론적 불안의 신체적 표현이다. 소녀는 하이데거가 말한 '세계 내 존재'로서 세계에 던져져 있지만, 그 세계에 온전히 속하지 못하는 경계적 존재이다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{04}{객관식}
\kfQStem{윗글을 바탕으로 <보기>를 감상한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}김시습의 「이생규장전」은 삶과 죽음의 경계를 사랑이 넘어서는 이야기이다. 이 작품은 존재와 부재의 문제를 다룬다. 최랑은 물리적으로 부재하지만(죽었지만), 사랑이라는 지향에 의해 존재한다. 이는 존재가 물리적 실체에만 의존하지 않음을 시사한다. 그러나 이 초월적 사랑은 영원하지 않으며, '인연이 다하면' 최랑은 떠나야 한다. 이별의 불가피성은 인간 존재의 유한성을 드러낸다.\end{kfEvidence}
\begin{kfChoices}
...
\kfStartNonlit{하이데거의 존재와 시간 외 4편}
...
\begin{kfEvidence}A 씨는 오랫동안 직장에서 상사의 지시에 따르고, 동료들이 하는 대로 행동하며 살아왔다. 어느 날 갑작스러운 건강 이상으로 자신의 죽음을 실감하게 된 A 씨는 극심한 불안에 빠졌다. 이후 A 씨는 이전과는 달리 자신이 진정으로 원하는 삶이 무엇인지를 진지하게 고민하기 시작했다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfEvidence}한 미술관 관람객이 같은 조각품을 정면, 측면, 후면에서 번갈아 보고 있다. 시선의 위치와 각도에 따라 보이는 모습은 매번 달라지지만, 관람객은 그것이 '같은 하나의 조각품'이라는 사실을 알고 있다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{03}{객관식}
\kfQStem{윗글을 바탕으로 <보기>를 이해한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}갑은 사고로 기억을 모두 잃었지만, 사고 전의 성격, 습관, 가치관은 그대로 유지하고 있다. 을은 갑의 사고 이전 기억을 완벽하게 이식받았지만, 성격과 습관은 을 자신의 것을 유지하고 있다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{04}{객관식}
\kfQStem{윗글을 바탕으로 <보기>를 이해한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}숙련된 자전거 선수가 울퉁불퉁한 산길을 고속으로 주행하고 있다. 선수는 매 순간 변하는 노면 상태에 즉각적으로 반응하여 몸의 균형을 유지하면서, 의식적으로는 코너를 돌아갈 전략만 생각하고 있다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{01}{객관식}
\kfQStem{<보기>의 ㄱ\textasciitilde{}ㅁ의 이유를 추론한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}ㄱ. 식물의 잎을 제거하면 식물이 정상적으로 자라지 못한다. \\\relax
ㄴ. 뿌리 분열대에 해당하는 부분을 잘라 내면 길이 생장이 일어나지 않는다. \\\relax
ㄷ. 당근을 신장대 자극 용액에 담가 두자 뿌리가 빠르게 길어졌다. \\\relax
ㄹ. 뿌리 표면 한 부분에 잉크 점을 찍고 시간이 지나자 뿌리는 길어졌지만 점 위치는 변하지 않았다. \\\relax
ㅁ. 나무줄기 횡단면에는 가로·세로 무늬 차이가 나타난다.\end{kfEvidence}
\begin{kfChoices}
...
\kfQStem{㉠의 이유로 가장 적절하지 \underline{않은} 것은?}
\begin{kfChoices}
...
\kfQStem{윗글을 읽고 <보기>를 이해한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}• 화가 A는 폭풍우 치는 바다를 보며 두려움과 경외가 뒤섞인 내적 이미지를 형성했다. A는 이를 캔버스에 옮기기 위해 추상적인 선과 색채로 화면을 구성했다. \\\relax
• 작곡가 B는 불안한 심리를 점점 빨라지는 리듬과 불협화음의 반복으로 표현했다. 공연장에서 이 곡을 들은 감상자 C는 불안과 긴장을 알아보았다.\end{kfEvidence}
\begin{kfChoices}
...
새벽 밀물에 밀려온 거미이냐   다 삭아 빠진 소라 껍질에 나는 붙어 왔다   먼 항구의 노정(路程)*에 흘러간 생활을 들여다보며
...
\kfQStem{(가)에 대한 이해로 적절하지 \underline{않은} 것은?}
\begin{kfChoices}
...
\kfQStem{㉠∼㉣에 대한 설명으로 가장 적절하지 \underline{않은} 것은?}
\begin{kfChoices}
...
\begin{kfChapterAreaList}
\kfChapterAreaItem{문법}{kfAreaGrammar}{음운 / 음절의 끝소리 규칙 + 연음 심화}
\kfChapterAreaItem{문학}{kfAreaLiterature}{「장마」 — 윤흥길 외 4편}
\kfChapterAreaItem{비문학}{kfAreaNonlit}{「공리주의의 세 갈래」 외 4편}
\kfChapterAreaItem{실력 확인}{kfAreaWeekly}{패턴 워크북 — 총 ?문항}
\end{kfChapterAreaList}

\kfStartGrammar{음운 / 음절의 끝소리 규칙 + 연음 심화}
...
\begin{kfQBlock}{01}{객관식}
\kfQStem{윗글을 바탕으로 <보기>의 발음으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}ⓐ 부엌[부억]  ⓑ 낫[낟]  ⓒ 삶[삼]  ⓓ 밟다[밥따]  ⓔ 읽다[일따]\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfEvidence}ⓐ 낮이[나지]    ⓑ 삶을[살믈]    ⓒ 밖에[바게] \\\relax
ⓓ 꽃 아래[꼬다래]    ⓔ 없어[업서]\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{03}{객관식}
\kfQStem{윗글을 바탕으로 <보기>의 발음이 표준 발음법에 맞는지 판단한 것으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}ⓐ 넓다[널따]  ⓑ 밟고[밥꼬]  ⓒ 넓적[넙쩍]  ⓓ 맑다[말따]  ⓔ 삶다[삼따]\end{kfEvidence}
\begin{kfChoices}
...
\par\needspace{25\baselineskip}
\kfPassageFull{끝소리 규칙과 복합 음운 변동}{%
...
\begin{kfEvidence}'젖먹이'의 발음 과정을 단계별로 분석하시오.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{05}{객관식}
\kfQStem{윗글을 바탕으로 <보기>의 밑줄 친 부분의 발음과 그 이유를 분석한 것으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}ⓐ 닭을 [달글]    ⓑ 꽃 위 [꼬뒤] \\\relax
ⓒ 헛일 [헌닐]    ⓓ 값어치 [가버치]\end{kfEvidence}
\begin{kfChoices}
...
\kfStartLit{「장마」 — 윤흥길 외 4편}


\kfPassageNote{「장마」 — 윤흥길}{%
...
\begin{kfQBlock}{04}{객관식}
\kfQStem{윗글을 바탕으로 <보기>를 감상한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}윤흥길의 「장마」는 6·25 전쟁이 한 가정에 남긴 이념 갈등을 다룬다. 이 작품에서 갈등의 핵심은 국군과 인민군이라는 적대적 이념이 혈연관계와 충돌하는 데 있다. 어린 서술자는 이 갈등의 의미를 완전히 이해하지 못하지만, 감각적으로 포착함으로써 독자에게 전달한다. 결말의 화해는 이념의 논리가 아닌 인간적 연민에 의해 가능해진다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{03}{객관식}
\kfQStem{주인공이 노인에게서 '자기 아버지의 모습'을 본 뒤 '부끄러워졌다'가 오래가지 \underline{않은} 이유로 가장 적절한 것은?}
\begin{kfChoices}
...
\begin{kfQBlock}{04}{객관식}
\kfQStem{윗글을 바탕으로 <보기>를 감상한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}윤흥길의 「완장」은 권력이 개인의 도덕적 주체를 어떻게 붕괴시키는지를 보여준다. 특히 작품의 아이러니는 이 권력이 극히 미미한 것이라는 데 있다. 저수지 관리원이라는 사소한 지위조차 인간을 변질시킬 수 있다면, 이는 권력의 유혹이 인간 본성에 깊이 뿌리 내리고 있음을 시사한다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{04}{객관식}
\kfQStem{<보기>를 바탕으로 윗시를 감상한 내용으로 적절하지 \underline{않은} 것은? [3점]}
\begin{kfEvidence}윤동주의 「위로」는 일제 강점기의 부정적 현실을 배경으로, ‘거미–나비–사나이’의 우화적 장면을 통해 우리 민족의 무기력한 처지를 형상화한 산문시이다. ‘거미’는 일제를, ‘나비’는 우리 민족을, ‘젊은 사나이’는 식민지 현실에 무기력하게 머무는 시인 자신과 동시대인을 상징한다. 화자는 거미줄을 헝클어 버리는 행위를 통해 사나이를 위로하지만, 이 행위가 근본적 해결이 아님을 자각하면서 안타까움도 함께 드러낸다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{03}{객관식}
\kfQStem{김 시인이 '가난해도 가난에 구차하지 \underline{않은} 사람이 되고 싶다'는 시를 쓴 것이 드러내는 인물의 가치관으로 가장 적절한 것은?}
\begin{kfChoices}
...
\begin{kfQBlock}{04}{객관식}
\kfQStem{윗글을 바탕으로 <보기>를 감상한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}양귀자의 「원미동 시인」은 서민의 일상 속에서 도덕적 선택의 의미를 묻는다. 이 작품에서 윤리란 거창한 원리가 아니라, 이웃의 고통에 반응하는 작은 행위에서 나타난다. 김 시인의 선택은 합리적 이익 계산을 넘어서는 것이며, 시를 쓴다는 행위 자체가 삶에 품위를 더하는 윤리적 실천이다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{04}{객관식}
\kfQStem{윗글을 바탕으로 <보기>를 감상한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}「수궁가」는 충의와 지혜의 갈등, 목적과 수단의 윤리적 문제를 다룬다. 별주부의 충성은 유교적 덕목이지만, 그것을 실현하기 위해 무고한 존재를 속이고 해치는 것은 수단의 정당성 문제를 제기한다. 한편 토끼의 기지는 약자의 생존 전략이면서도 거짓말이라는 윤리적 문제를 안고 있다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{03}{객관식}
\kfQStem{윗글을 바탕으로 <보기>를 이해한 내용으로 적절한 것은?}
\begin{kfEvidence}한 의사가 건강한 사람 한 명의 장기를 적출하여 다섯 명의 생명을 구할 수 있는 상황에 처해 있다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{03}{객관식}
\kfQStem{윗글을 바탕으로 <보기>를 이해한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}A는 어려서부터 타인의 고통에 무관심했지만, 자원봉사 활동을 통해 점차 타인의 고통에 민감하게 반응하게 되었다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{04}{객관식}
\kfQStem{윗글을 바탕으로 <보기>를 이해한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}갑은 부모가 아프다는 소식을 듣고 마음속으로 걱정은 했지만, 바쁜 업무를 핑계로 방문하지 않았다. 을은 같은 상황에서 즉시 업무를 정리하고 부모를 찾아가 간병했다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{03}{객관식}
\kfQStem{윗글을 바탕으로 <보기>를 이해한 내용으로 적절한 것은?}
\begin{kfEvidence}한 사회에서 의사의 소득이 일반 노동자의 5배이다. 이 불평등이 정당화될 수 있는가?\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{03}{객관식}
\kfQStem{윗글을 바탕으로 <보기>를 이해한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}갑은 아프리카 기아 지역에 대한 감동적인 영상을 보고 즉시 그 단체에 100만 원을 기부했다. 을은 같은 100만 원으로 어떤 단체에 기부하는 것이 가장 많은 생명을 구할 수 있는지 비교 분석한 뒤 기부했다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{03}{객관식}
\kfQStem{(가)와 (나)를 바탕으로 <보기>의 ⓐ와 ⓑ에 대해 이해한 내용으로 적절하지 \underline{않은} 것은?}
...
\begin{kfQBlock}{05}{객관식}
\kfQStem{ⓐ의 정책 효과에 대한 설명으로 적절하지 \underline{않은} 것은?}
\begin{kfChoices}
...
\begin{kfQBlock}{07}{객관식}
\kfQStem{㉠의 근거를 추론한 내용으로 가장 적절하지 \underline{않은} 것은?}
\begin{kfChoices}
...
\begin{kfQBlock}{09}{객관식}
\kfQStem{<보기>를 바탕으로 소비 함수를 이해한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}어떤 나라의 가처분 소득이 2026년에 200억 원, 소비가 150억 원이었다. 2027년에는 가처분 소득이 210억 원, 소비가 156억 원이 되었다. 이 나라의 소비 함수는 C=a+bYd 형태라고 가정한다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{11}{객관식}
\kfQStem{㉠ \textasciitilde{} ㉤에 대한 이해로 적절하지 \underline{않은} 것은?}
\begin{kfChoices}
...
\begin{kfQBlock}{16}{객관식}
\kfQStem{<보기>를 바탕으로 윗글을 감상한 것으로 적절하지 \underline{않은} 것은? [3점]}
\begin{kfChoices}
...
\begin{kfChapterAreaList}
\kfChapterAreaItem{문법}{kfAreaGrammar}{음운 / 비음화·유음화 + 복합 음운 변동}
\kfChapterAreaItem{문학}{kfAreaLiterature}{「성산별곡」 — 정철 외 4편}
\kfChapterAreaItem{비문학}{kfAreaNonlit}{「노자와 한비자 — 도가와 법가의 분기」 외 4편}
\kfChapterAreaItem{실력 확인}{kfAreaWeekly}{패턴 워크북 — 총 ?문항}
\end{kfChapterAreaList}

\kfStartGrammar{음운 / 비음화·유음화 + 복합 음운 변동}
...
\begin{kfQBlock}{01}{객관식}
\kfQStem{윗글을 바탕으로 <보기>의 단어들에서 비음화가 적용되는 과정을 분석한 것으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}ⓐ 먹는[멍는]  ⓑ 십만[심만]  ⓒ 있는[인는]  ⓓ 꽃말[꼰말]  ⓔ 법률[범뉼]\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfEvidence}ⓐ 난로[날로]    ⓑ 진리[질리]    ⓒ 물난리[물랄리] \\\relax
ⓓ 의견란[의견난]    ⓔ 칼날[칼랄]\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{03}{객관식}
\kfQStem{윗글을 바탕으로 <보기>의 단어에 적용된 음운 변동을 분석한 것으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}ⓐ 협력[혐녁]    ⓑ 찰나[찰라]    ⓒ 백리[뱅니] \\\relax
ⓓ 실내[실래]    ⓔ 법률[범뉼]\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfEvidence}「닫는」, 「읊는」의 발음 과정을 각각 분석하시오.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{05}{객관식}
\kfQStem{윗글을 바탕으로 <보기>의 각 단어에 적용된 동화의 방향과 정도를 분석한 것으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}ⓐ 국민[궁민]    ⓑ 신라[실라]    ⓒ 설날[설랄]    ⓓ 밥물[밤물]\end{kfEvidence}
\begin{kfChoices}
...
\kfStartLit{「성산별곡」 — 정철 외 4편}


\kfPassageNote{「성산별곡」 — 정철}{%
...
\begin{kfQBlock}{05}{객관식}
\kfQStem{윗글을 바탕으로 <보기>를 감상한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}「성산별곡」은 정철이 김성원의 식영정 생활을 노래한 것으로, 자연 속 은거와 유교적 도학의 실천이 결합된 작품이다. 조선 전기 사대부 문인들에게 자연은 단순한 풍류의 공간이 아니라, 도(道)를 체득하는 수양의 장이었다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{05}{객관식}
\kfQStem{윗글을 바탕으로 <보기>를 감상한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}「사미인곡」에서 정철은 굴원의 이소(離騷) 전통을 계승하여, 임금과 신하의 관계를 남녀의 관계에 빗대어 표현했다. 이 작품에서 '님'은 임금을, 화자인 '여성'은 신하인 정철 자신을 의미한다. 이러한 표현 방식은 직접적인 충성 표현보다 문학적 깊이를 더한다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{05}{객관식}
\kfQStem{윗시를 바탕으로 <보기>를 감상한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}조선 전기 사대부 문인들은 '강호가도(江湖歌道)'라 하여 자연 속 은거 생활을 시조로 노래하는 전통을 형성했다. 이들에게 자연은 정치에서 물러난 공간이면서도 군주에 대한 충성을 잊지 않는 공간이었다. 이러한 이중적 태도가 강호가도의 핵심이다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{05}{객관식}
\kfQStem{윗시를 바탕으로 <보기>를 감상한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}조선 시대 사대부들은 유교적 덕목인 '안빈낙도(安貧樂道)'를 실천하고자 했다. 이는 가난한 삶 속에서도 도(道)를 즐기며 흔들리지 않는 마음가짐을 뜻한다. 자연 속의 삶은 이러한 정신을 실현하는 공간으로 여겨졌다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{05}{객관식}
\kfQStem{윗글을 바탕으로 <보기>를 감상한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}조선 시대 일부 가사 작품은 직접적인 정치적 발언 대신, 일상적 소재를 비유로 활용하여 정치적 메시지를 전달하는 방식을 취했다. 「고공가」는 주인과 머슴이라는 일상적 관계를 빌려 군신(君臣) 관계의 도리를 노래한 대표적 사례이다.\end{kfEvidence}
\begin{kfChoices}
...
\kfStartNonlit{노자와 한비자 — 도가와 법가의 분기 외 4편}
...
\begin{kfQBlock}{03}{객관식}
\kfQStem{윗글을 바탕으로 <보기>를 이해한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}A국의 왕은 유능한 재상 갑(甲)에게 국정을 일임한 뒤 자신은 궁궐 깊숙이 물러나 아무런 지시도 내리지 않았다. 갑은 스스로의 판단으로 정책을 시행하여 나라를 잘 다스렸으나, 시간이 지나자 갑의 권위가 왕을 능가하게 되었다. 백성은 갑의 이름만 알 뿐 왕의 존재를 잊었다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{03}{객관식}
\kfQStem{윗글을 바탕으로 <보기>를 이해한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}물은 높은 곳에서 낮은 곳으로 흐르는 법칙을 따른다. 그러나 실제로 물이 흐르려면 물이라는 물질이 있어야 한다. 법칙만 있고 물이 없으면 흐름은 일어나지 않으며, 물이 있어도 법칙이 없으면 어디로 흐를지 정해지지 않는다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{04}{객관식}
\kfQStem{윗글을 바탕으로 <보기>를 이해한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}어떤 교향악단에서 지휘자 없이 연주를 했다. 각 단원은 악보와 자신의 음악적 감각에 따라 연주했을 뿐인데, 결과적으로 놀라울 정도로 조화로운 음악이 만들어졌다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{02}{객관식}
\kfQStem{윗글에서 팔식(八識)의 기능을 정리한 것으로 적절하지 \underline{않은} 것은?}
\begin{kfChoices}
...
\begin{kfQBlock}{03}{객관식}
\kfQStem{윗글을 바탕으로 <보기>를 이해한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}철수는 시장에서 과일을 보았다. 눈으로 빨간색을 인식하고, 코로 달콤한 향을 맡았다. 그는 '아, 이것은 사과구나'라고 판단한 뒤, 예전에 먹었던 사과의 맛을 떠올리며 구매를 결정했다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{03}{객관식}
\kfQStem{윗글의 이황과 이이의 견해를 비교한 것으로 적절하지 \underline{않은} 것은?}
\begin{kfChoices}
...
\begin{kfQBlock}{04}{객관식}
\kfQStem{윗글을 바탕으로 <보기>를 이해한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}갑(甲)은 길에서 다친 아이를 보고 측은한 마음이 일어나 달려가 도와주었다. 을(乙)은 불의를 보고 분노하여 항의했으나, 분노가 지나쳐 폭력을 행사했다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{02}{객관식}
\kfQStem{<보기>의 시스템 설계를 윗글과 연결해 이해한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}자율주행 시스템은 센서 융합 전처리와 제어 판단, 대규모 행렬 기반 객체 인식, 예외 상황 판단을 동시에 처리한다. 시스템은 CPU·GPU·NPU에 작업을 분담하고, 상황에 따라 장치 간 연산 흐름을 조정한다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{04}{객관식}
\kfQStem{[01] 윗글에 대한 이해로 적절하지 \underline{않은} 것은?}
\begin{kfChoices}
...
\begin{kfQBlock}{05}{객관식}
\kfQStem{[02] 윗글을 바탕으로 <보기>를 이해한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}쿼티(QWERTY) 자판 배열은 타자기의 기계적 충돌을 방지하기 위해 고안된 것이다. 오늘날 컴퓨터 키보드는 타자기에서와 같은 기계적 충돌을 염려할 필요가 없기 때문에 입력 효율 면에서 쿼티보다 더 우수하다고 평가되는 여러 새로운 자판 배열이 개발되었다. 그러나 이미 쿼티 자판이 전 세계적으로 표준화되어 널리 보급된 상태이기 때문에, 새로운 배열 자판의 사용률은 매우 저조하다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{06}{객관식}
\kfQStem{㉠과 ㉡에 대한 설명으로 적절하지 \underline{않은} 것은?}
\begin{kfChoices}
...
\begin{kfQBlock}{07}{객관식}
\kfQStem{(가)를 바탕으로 추론한 내용으로 가장 적절하지 \underline{않은} 것은?}
\begin{kfChoices}
...
\begin{kfQBlock}{08}{객관식}
\kfQStem{(가)의 논지를 바탕으로 추론한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfChoices}
...
\begin{kfQBlock}{14}{객관식}
\kfQStem{윗글의 서술상의 특징으로 가장 적절하지 \underline{않은} 것은?}
\begin{kfChoices}
...
\begin{kfQBlock}{16}{객관식}
\kfQStem{<보기>를 바탕으로 (가), (나)를 감상한 내용으로 적절하지 \underline{않은} 것은? [3점]}
\begin{kfChoices}
...
\begin{kfQBlock}{18}{객관식}
\kfQStem{<보기>를 바탕으로 (가)\textasciitilde{}(다)를 감상한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfChoices}
...
\begin{kfChapterAreaList}
\kfChapterAreaItem{문법}{kfAreaGrammar}{음운 / 구개음화·된소리되기 + 음운 변동 유형 분류 종합}
\kfChapterAreaItem{문학}{kfAreaLiterature}{「춘향전」 — 작자 미상 외 4편}
\kfChapterAreaItem{비문학}{kfAreaNonlit}{「법률행위의 무효와 취소」 외 4편}
\kfChapterAreaItem{실력 확인}{kfAreaWeekly}{패턴 워크북 — 총 ?문항}
\end{kfChapterAreaList}

\kfStartGrammar{음운 / 구개음화·된소리되기 + 음운 변동 유형 분류 종합}
...
\begin{kfEvidence}ㄱ. 굳이[구지] \\\relax
ㄴ. 디디다[디디다] \\\relax
ㄷ. 붙이다[부치다] \\\relax
ㄹ. 닫히다[다치다] \\\relax
ㅁ. 티끌[티끌]\end{kfEvidence}
\begin{kfChoices}
\kfChoice ㄱ, ㄷ
\kfChoice ㄱ, ㄷ, ㄹ
\kfChoice ㄱ, ㄴ, ㄷ
...
\begin{kfEvidence}ⓐ 학교[학꾜]    ⓑ 안다[안따]    ⓒ 할 수[할 쑤]    ⓓ 갈등[갈뜽]    ⓔ 문법[문뻡]\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfEvidence}ⓐ 놓고[노코]    ⓑ 꽃잎[꼰닙]    ⓒ 쓰어→써    ⓓ 맏이[마지]\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfEvidence}ⓐ 꽃을[꼬츨] → 연음    ⓑ 닫히다[다치다] → 축약+구개음화 \\\relax
ⓒ 솜이불[솜니불] → 첨가    ⓓ 국물[궁물] → 비음화\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfEvidence}「읽히다」의 발음[일키다]를 도출하는 과정을 분석하시오.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{02}{객관식}
\kfQStem{윗글에서 변학도의 죄상 중 '관기 \underline{아닌} 양인의 딸에게 수청을 강요한 죄'가 지닌 의미로 가장 적절한 것은?}
\begin{kfChoices}
...
\begin{kfQBlock}{05}{객관식}
\kfQStem{윗글을 바탕으로 <보기>를 감상한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}「춘향전」은 조선 후기 사회에서 신분 제도의 모순과 부패한 관리의 횡포를 비판하는 작품이다. 동시에 사랑의 성취와 정의의 실현이라는 보편적 가치를 추구한다. 특히 암행어사라는 제도적 장치를 통해 '법과 정의'의 문제를 서사적으로 풀어낸다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{05}{객관식}
\kfQStem{윗글을 바탕으로 <보기>를 감상한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}이 작품은 남편이 저지른 일을 아내가 수습하는 서사가 중심이 된다. 춘풍은 가장이지만 경제관념 없이 현실적 쾌락만을 추구하며 자신이 초래한 문제를 해결하려 하지 않는다. 반면 춘풍 아내는 적극적으로 현실의 문제를 해결하려는 의지를 갖고 주도면밀하게 목적을 달성한다. 이러한 두 인물의 대비를 통해 무능한 가장의 모습과 주체적인 아내의 역할 및 능력이 부각된다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{04}{객관식}
\kfQStem{윗글을 바탕으로 <보기>를 감상한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}「유충렬전」은 충(忠)과 역(逆)의 대립을 서사의 중심에 놓고, 충신의 승리와 간신의 몰락을 통해 권선징악의 주제를 구현한다. 이 과정에서 법과 제도가 간신에 의해 악용되었다가, 군주의 올바른 판단에 의해 회복되는 구조를 보여준다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{04}{객관식}
\kfQStem{윗글을 바탕으로 <보기>를 감상한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}박태원은 1930년대 경성(서울)을 배경으로 모더니즘 소설을 실험한 작가이다. 그의 작품에서는 작가의 직접적 개입 없이 인물의 외부 행동을 관찰자 시점으로 묘사하는 '카메라 아이(camera eye)' 기법이 자주 사용된다. 이를 통해 식민지 근대 도시의 모습을 담담히 기록한다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{04}{객관식}
\kfQStem{윗글을 바탕으로 <보기>를 감상한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}현대 자본주의 사회에서 인간은 경제적 의무(대출·이자·세금 등)에 묶여 자유로운 삶을 영위하기 어려운 경우가 많다. 이동하의 「저당 잡힌 사내」는 이러한 경제적 속박이 인간의 존엄과 자유를 어떻게 훼손하는지를 '저당'이라는 법적·경제적 비유를 통해 형상화한다.\end{kfEvidence}
\begin{kfChoices}
...
\kfStartNonlit{법률행위의 무효와 취소 외 4편}
...
\begin{kfQBlock}{02}{객관식}
\kfQStem{윗글의 '무효'와 '취소'를 비교한 것으로 적절하지 \underline{않은} 것은?}
\begin{kfChoices}
...
\begin{kfQBlock}{03}{객관식}
\kfQStem{윗글을 바탕으로 <보기>를 이해한 내용으로 적절한 것은?}
\begin{kfEvidence}갑(甲)은 을(乙)의 사기에 속아 자신의 토지를 을에게 매도하였다. 을은 이 토지를 사기 사실을 전혀 모르는 병(丙)에게 다시 매도하였다. 이후 갑은 을의 사기를 알게 되어 매매 계약을 취소하였다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfEvidence}'공원에서 자동차를 운전하는 것을 금지한다'라는 규정이 있다. 이 규정에 전동 킥보드에 대한 언급은 없다. 그런데 전동 킥보드도 자동차와 마찬가지로 동력으로 움직이며 보행자에게 위험을 줄 수 있으므로, 이 규정을 전동 킥보드에도 적용할 수 있는지가 문제된다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{03}{객관식}
\kfQStem{윗글을 바탕으로 <보기>를 이해한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}갑(甲)은 무허가 건축물을 지어 행정청으로부터 철거 명령을 받았으나 이행하지 않았다. 행정청은 대집행 절차를 밟기로 결정했다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{03}{객관식}
\kfQStem{윗글을 바탕으로 <보기>를 이해한 내용으로 적절한 것은?}
\begin{kfEvidence}갑(甲)은 새로운 배터리 기술을 발명하여 특허 등록을 마쳤다. 을(乙)은 갑의 허락 없이 동일한 기술을 사용하여 배터리를 제조·판매하고 있다. 한편 병(丙)은 갑의 특허 기술을 연구 목적으로 실험실에서 시험하고 있다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{03}{객관식}
\kfQStem{윗글을 바탕으로 <보기>를 이해한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}갑(甲)은 10년 전 해난 사고로 실종되어 법원의 실종 선고를 받았다. 갑의 재산은 상속인 을(乙)에게 상속되었다. 그런데 최근 갑이 살아 있는 것이 확인되었다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{06}{객관식}
\kfQStem{㉠과 ㉡의 대응 전략을 비교한 설명으로 적절하지 \underline{않은} 것은?}
\begin{kfChoices}
...
\begin{kfQBlock}{07}{객관식}
\kfQStem{표피 효과가 도선의 발열을 증가시키는 이유로 가장 적절하지 \underline{않은} 것은?}
\begin{kfChoices}
...
\begin{kfQBlock}{10}{객관식}
\kfQStem{윗글과 <보기>를 바탕으로 판단한 내용으로 적절하지 \underline{않은} 것은?}
\begin{kfEvidence}A와 B는 결혼식을 올렸지만 혼인 신고를 하지 않은 채 4년간 동거했다. 이후 A는 일방적으로 관계를 종료했고, B는 사실혼 파기로 인한 손해배상을 검토하고 있다. 한편 C와 D는 혼인 신고를 마친 법률혼 부부로, 이혼에 합의한 뒤 가정법원 확인을 받고 숙려 기간을 거쳤다. 다만 두 사람은 확인 후 4개월이 지나서야 이혼 신고를 하려 한다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{13}{객관식}
\kfQStem{ⓐ～ⓔ에 대한 설명으로 적절하지 \underline{않은} 것은?}
\begin{kfChoices}
...
\begin{kfQBlock}{14}{객관식}
\kfQStem{윗글의 서술상 특징으로 가장 적절하지 \underline{않은} 것은?}
\begin{kfChoices}
...
\begin{kfQBlock}{15}{객관식}
\kfQStem{(나)에 대한 이해로 적절하지 \underline{않은} 것은?}
\begin{kfChoices}
...
\begin{kfQBlock}{16}{객관식}
\kfQStem{<보기>를 참고하여 윗글을 감상한 내용으로 적절하지 \underline{않은} 것은? [3점]}
\begin{kfChoices}

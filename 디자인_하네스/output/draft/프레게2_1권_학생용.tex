...
\kfChapterAreaItem{개념}{kfAreaConcept}{화자, 청자}
\kfChapterAreaItem{문학}{kfAreaLiterature}{배경 지식 돋보기}
\kfChapterAreaItem{비문학}{kfAreaNonlit}{신분과 능력이 부딪치다, 조선의 신분 제도}
...
\kfActivityBg \par\kfMaybeNeedspace{24\baselineskip}\noindent{\kfTipMark\,\,}{\small\color{kfInk} [1-5] <보기>에서 알맞은 단어를 골라 문장을 완성하세요.}\par\nopagebreak[4]\smallskip\nopagebreak[4]
\begin{kfBlankList}
...
\kfActivityBg \par\kfMaybeNeedspace{24\baselineskip}\noindent{\kfTipMark\,\,}{\small\color{kfInk} [1-5] 단어의 정확한 의미를 찾아 선으로 연결해 보세요.}\par\nopagebreak[4]\smallskip\nopagebreak[4]
\begin{kfConnect}
...
\kfActivityBg \par\kfMaybeNeedspace{18\baselineskip}\noindent{\kfTipMark\,\,}{\small\color{kfInk} [1-5] 뜻풀이에 알맞은 단어를 초성 힌트를 참고해 쓰세요.}\par\nopagebreak[4]\smallskip\nopagebreak[4]
...
\kfActivityBg \par\kfMaybeNeedspace{24\baselineskip}\noindent{\kfTipMark\,\,}{\small\color{kfInk} [1-3] 다음 시의 구절을 읽고 화자와 청자를 찾아보세요.}\par\nopagebreak[4]\smallskip\nopagebreak[4]
\begin{kfBlankList}
...
\kfActivityBg \par\kfMaybeNeedspace{24\baselineskip}\noindent{\kfTipMark\,\,}{\small\color{kfInk} 다음 진술이 맞으면 ○, 틀리면 × 표시하시오.}\par\nopagebreak[4]\smallskip\nopagebreak[4]

\kfSecHeader{kfAreaConcept}{문제}{}

\begin{kfQBlock}{01}{객관식}
\kfQStem{화자에 대한 설명으로 알맞지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
...
\kfQStem{화자: 비를 피할 곳이 \underline{없는} '길고양이'
...
\kfActivityBg \par\kfMaybeNeedspace{24\baselineskip}\noindent{\kfTipMark\,\,}{\small\color{kfInk} [1-4] 글의 내용과 일치하면 O, 일치하지 않으면 X를 쓰세요.}\par\nopagebreak[4]\smallskip\nopagebreak[4]
\begin{kfOXList}
...
\kfQStem{춘향이가 도련님에게 “안녕히 계세요”라고 말한 의미로 적절하지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
...
\kfQStem{이 시에서 '나무'가 의미하는 바로 알맞지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
...
\kfQStem{이 시의 주제로 알맞지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
...
\kfStartNonlit{신분과 능력이 부딪치다, 조선의 신분 제도}
...
\kfActivityBg \par\kfMaybeNeedspace{24\baselineskip}\noindent{\kfTipMark\,\,}{\small\color{kfInk} [1-4] 다음 단어의 뜻을 찾아 선으로 연결해 보세요.}\par\nopagebreak[4]\smallskip\nopagebreak[4]
\begin{kfConnect}
...
\end{kfQBlock}
\begin{kfQBlock}{05}{객관식}
\kfQStem{이 글을 통해 알 수 있는 조선 시대 신분 제도의 특징이 \uline{\underline{아닌}} 것은?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{07}{객관식}
\kfQStem{조선 시대에 '양반'이 누렸던 특권으로 알맞지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
...
\kfActivityBg \par\kfMaybeNeedspace{24\baselineskip}\noindent{\kfTipMark\,\,}{\small\color{kfInk} 다음 빈칸에 알맞은 말을 골라 채우시오.}\par\nopagebreak[4]\smallskip\nopagebreak[4]
...
\begin{kfEvidence}독립운동가들은 나라를 되찾기 위해 자신의 재산과 목숨까지 기꺼이 바쳤습니다. 그들의 숭고한 [　　　　　] 덕분에 우리는 자유로운 세상에서 살 수 있게 되었습니다.\end{kfEvidence}
\begin{kfChoices}
\kfChoice 신념
\kfChoice 희생
\kfChoice 절개
...
\begin{kfQBlock}{08}{객관식}
\kfQStem{㉠\textasciitilde{}㉣에 대한 설명으로 적절하지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
...
\begin{kfEvidence}보통 사람들은 죽음을 모든 것이 끝나는 '이별'이라고 생각합니다. 하지만 문학 작품에서는 죽음을 넘어선 영원한 사랑을 노래하기도 합니다. 몸은 사라져도 마음은 자연물(비, 바람, 나무 등)로 변하여 사랑하는 사람 곁에 남는다는 믿음을 보여줍니다.\end{kfEvidence}
\begin{kfChoices}
...
\kfQStem{조선 시대 신분 제도의 특징으로 알맞지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
...
\begin{kfEvidence}“나는 의술 실력이 뛰어나서 죽어가는 사람도 살려냈다. 하지만 신분이 낮다는 이유로 나라의 중요한 정책을 결정하는 높은 자리에 오를 수는 없었다.”\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfEvidence}“상민 출신인 김 씨가 장사를 해서 큰돈을 벌어 기와집을 짓고 잘 산다는 소문이 들린다.”\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfChapterAreaList}
\kfChapterAreaItem{어휘}{kfAreaVocab}{}
\kfChapterAreaItem{개념}{kfAreaConcept}{비유하기}
\kfChapterAreaItem{문학}{kfAreaLiterature}{배경 지식 돋보기}
\kfChapterAreaItem{비문학}{kfAreaNonlit}{국민이 주인인 나라, 민주주의와 깨어 있는 시민}
\kfChapterAreaItem{실력확인}{kfAreaWeekly}{}
\end{kfChapterAreaList}
...
\kfActivityBg \par\kfMaybeNeedspace{24\baselineskip}\noindent{\kfTipMark\,\,}{\small\color{kfInk} [1-3] 다음 비유적 표현에서 '원관념'과 '보조 관념'을 찾아보세요.}\par\nopagebreak[4]\smallskip\nopagebreak[4]
\begin{kfBlankList}
\kfBlankItem “시간은 금이다.”
...
\begin{kfQBlock}{01}{객관식}
\kfQStem{다음 중 '은유법'이 사용되지 \uline{\underline{않은}} 문장은 무엇인가요?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{03}{객관식}
\kfQStem{다음 문장에 사용된 비유법과 원관념이 바르게 짝지어지지 \uline{\underline{않은}} 것은 무엇인가요?}
...
\kfActivityBg \par\kfMaybeNeedspace{24\baselineskip}\noindent{\kfTipMark\,\,}{\small\color{kfInk} [1-2] 배경 지식을 바탕으로 볼 때, 다음 시어들이 실제로 의미하는 것은 무엇일까요? 선으로 연결해 보세요.}\par\nopagebreak[4]\smallskip\nopagebreak[4]
\begin{kfConnect}
\kfPair{풀}{㉠ 국민들을 억누르는 독재 권력이나 힘든 시련}
\kfPair{비바람}{㉡ 억압에도 굴하지 않고 다시 일어나는 강한 시민들}
\end{kfConnect}

\kfActivityBg \par\kfMaybeNeedspace{24\baselineskip}\noindent{\kfTipMark\,\,}{\small\color{kfInk} [1-5] 글의 내용과 일치하면 O, 일치하지 않으면 X를 쓰세요.}\par\nopagebreak[4]\smallskip\nopagebreak[4]
\begin{kfOXList}
...
\end{kfQBlock}
\begin{kfQBlock}{06}{객관식}
\kfQStem{시의 내용에 따르면 '풀'의 행동으로 알맞지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
...
\kfStartNonlit{국민이 주인인 나라, 민주주의와 깨어 있는 시민}
...
\kfActivityBg \par\kfMaybeNeedspace{24\baselineskip}\noindent{\kfTipMark\,\,}{\small\color{kfInk} [1-3] 다음 단어와 그 뜻이 올바르게 연결되도록 선을 그으세요.}\par\nopagebreak[4]\smallskip\nopagebreak[4]
\begin{kfConnect}
...
\end{kfQBlock}
\begin{kfQBlock}{05}{객관식}
\kfQStem{이 글을 읽고 알 수 있는 내용으로 적절하지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{06}{객관식}
\kfQStem{이 글의 중심 내용으로 알맞지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
...
\begin{kfEvidence}5학년 지수는 학교 앞 횡단보도가 위험하다고 생각했습니다. 그래서 시청 홈페이지에 “어린이 보호 구역 안전장치를 설치해 주세요”라는 글을 올렸습니다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{01}{객관식}
\kfQStem{다음 단어와 그 뜻풀이가 바르게 연결되지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
...
\begin{kfEvidence}“민주주의 국가에서 모든 \kfFillBlank[30mm]{}은 국민으로부터 나온다.”\end{kfEvidence}
\begin{kfChoices}
\kfChoice 왕
\kfChoice 독재
\kfChoice 권력
...
\begin{kfQBlock}{07}{객관식}
\kfQStem{시의 내용에 대한 설명으로 알맞지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
...
\begin{kfQBlock}{13}{객관식}
\kfQStem{오늘날 시민들이 정치에 참여하는 방법으로 알맞지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
...
\begin{kfEvidence}A나라의 국민들은 정치에 관심이 없습니다. 선거일에는 투표하러 가는 대신 놀러 가고, 뉴스는 재미없다며 보지 않습니다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{15}{객관식}
\kfQStem{위 글의 내용을 바탕으로 추론한 내용 중 적절하지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
...
\begin{kfEvidence}이 비유법은 원관념과 보조 관념을 'A는 B다'와 같은 형식으로 은근하게 연결합니다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfChapterAreaList}
\kfChapterAreaItem{어휘}{kfAreaVocab}{}
\kfChapterAreaItem{개념}{kfAreaConcept}{유의어, 반의어}
\kfChapterAreaItem{문학}{kfAreaLiterature}{배경 지식 돋보기}
\kfChapterAreaItem{비문학}{kfAreaNonlit}{우리 몸을 지키는 든든한 방패, 면역}
\kfChapterAreaItem{실력확인}{kfAreaWeekly}{}
\end{kfChapterAreaList}
...
\kfActivityBg \par\kfMaybeNeedspace{24\baselineskip}\noindent{\kfTipMark\,\,}{\small\color{kfInk} [1-5] 뜻이 서로 비슷한 단어끼리 선으로 연결해 보세요.}\par\nopagebreak[4]\smallskip\nopagebreak[4]
\begin{kfConnect}
\kfPair{증가}{㉠ 늘어남}
\kfPair{이유}{㉡ 근심}
\kfPair{희망}{㉢ 가난}
...
\kfActivityBg \par\kfMaybeNeedspace{18\baselineskip}\noindent{\kfTipMark\,\,}{\small\color{kfInk} 다음 조건에 맞게 글을 써 보세요.}\par\nopagebreak[4]\smallskip\nopagebreak[4]
\kfWritingPrompt{황씨 아저씨에게 암소는 다시 일어설 수 있게 해주는 소중한 '희망'이었습니다. 여러분에게도 힘든 순간에 힘이 되어주는 '희망'이 있나요? * 나의 보물: \kfFillBlank[30mm]{} * 이유:}
\kfWriting{답안 작성}{8}
...
\end{kfQBlock}
\begin{kfQBlock}{08}{단답형}
\kfQStem{1960\textasciitilde{}70년대, 기계를 갖춘 큰 공장이 생겨나고 사회가 빠르게 발전하던 현상을 \kfFillBlank[30mm]{}(이)라고 합니다.}
\kfAnswerLines{1}
\end{kfQBlock}
\begin{kfQBlock}{09}{단답형}
\kfQStem{황씨 아저씨네 무명천 공장이 문을 닫게 된 결정적인 이유는 새롭고 화려한 합성 섬유인 \kfFillBlank[30mm]{}이/가 유행했기 때문입니다.}
\kfAnswerLines{1}
\end{kfQBlock}
\begin{kfQBlock}{10}{단답형}
\kfQStem{이 소설에서 '암소'는 황씨 아저씨가 빚을 갚고 재기할 수 있는 마지막 \kfFillBlank[20mm]{}을/를 상징합니다.}
\kfAnswerLines{1}
\end{kfQBlock}
...
\kfQStem{소가 죽은 뒤, 마을 사람들의 겉모습과 속마음이 어떻게 달랐는지 쓰세요. 1) 겉으로는: \kfFillBlank[30mm]{} 2) 속으로는:}
\kfAnswerNote{답안}{4}
\end{kfQBlock}


\kfStartNonlit{우리 몸을 지키는 든든한 방패, 면역}
...
\kfActivityBg \par\kfMaybeNeedspace{24\baselineskip}\noindent{\kfTipMark\,\,}{\small\color{kfInk} [1-4] 다음은 글에 나온 낱말들입니다. 낱말의 뜻풀이와 알맞게 연결하세요.}\par\nopagebreak[4]\smallskip\nopagebreak[4]
\begin{kfConnect}
...
\kfActivityBg \par\kfMaybeNeedspace{18\baselineskip}\noindent{\kfTipMark\,\,}{\small\color{kfInk} [1-1] 다음 활동을 해보세요.}\par\nopagebreak[4]\smallskip\nopagebreak[4]
...
\end{kfQBlock}
\begin{kfQBlock}{06}{객관식}
\kfQStem{이 글에서 사용된 비유적 표현과 그 의미가 바르게 연결되지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
\kfChoice 성벽 - 백혈구
\kfChoice 군인 - 항체
\kfChoice 무기 - 피부와 점막
...
\end{kfQBlock}
\begin{kfQBlock}{07}{객관식}
\kfQStem{다음 대화의 빈칸에 들어갈 말이 바르게 짝지어지지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfEvidence}환자: “선생님, 독감 백신 주사는 왜 맞는 건가요?” \\\relax
의사: “백신은 우리 몸이 미리 병균과 싸우는 연습을 하도록 도와주는 거예요. 마치 군인들이 전쟁 전에 미리 ( ① )을/를 하는 것과 같답니다.” \\\relax
환자: “아, 그럼 백신을 맞으면 우리 몸속에 무기가 생기나요?” \\\relax
의사: “맞아요. 우리 몸은 백신을 보고 병균을 물리칠 수 있는 ( ② )라는 무기를 미리 만들어 놓습니다.” \\\relax
환자: “그럼 나중에 진짜 독감 병균이 들어오면 어떻게 되나요?” \\\relax
의사: “우리 몸은 예전에 만든 무기를 ( ③ )하고 있다가, ( ④ ) 독감 바이러스가 들어오면 아주 빠르게 물리칠 수 있게 된답니다.”\end{kfEvidence}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{08}{객관식}
\kfQStem{1단계 보호에서 '성벽' 역할을 하며 병균이 들어오지 못하게 막는 것이 \uline{\underline{아닌}} 것은 무엇인가요?}
\begin{kfChoices}
\kfChoice 백혈구와 항체
\kfChoice 피부와 점막
\kfChoice 백신과 항체
...
\end{kfQBlock}
\begin{kfQBlock}{09}{객관식}
\kfQStem{병균이 몸속으로 들어왔을 때 싸우는 '군인' 역할을 하는 세포가 \uline{\underline{아닌}} 것은 무엇인가요?}
\begin{kfChoices}
\kfChoice 적혈구
\kfChoice 백혈구
\kfChoice 피부 세포
...
\end{kfQBlock}
\begin{kfQBlock}{10}{객관식}
\kfQStem{'백신'을 만드는 재료로 알맞지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
\kfChoice 건강한 사람의 피
\kfChoice 깨끗한 물과 소금
...
\begin{kfQBlock}{09}{객관식}
\kfQStem{다음 중 소설의 내용과 일치하지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
...
\begin{kfQBlock}{10}{객관식}
\kfQStem{이 글을 읽고 아래 <보기>를 참고하여 황씨 아저씨의 상황을 이해한 것으로 가장 적절하지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfEvidence}산업화 시대의 '거대한 바람'은 개인의 노력이나 의지와 상관없이 많은 것을 변화시키고 파괴합니다. 이 소설에서 황씨 아저씨는 시대의 흐름에 저항하지 못하고 끝내 좌절하는 인물로 그려집니다.\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{11}{객관식}
\kfQStem{윗글의 내용과 일치하지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
...
\begin{kfEvidence}가. 피부와 점막이 병균의 침입을 막습니다. \\\relax
나. 백혈구가 출동하여 병균을 잡아먹습니다. \\\relax
다. 병균과 싸울 수 있는 항체가 만들어집니다. \\\relax
라. 코와 목 안의 점막이 세균을 끈적하게 붙잡습니다.\end{kfEvidence}
\begin{kfChoices}
\kfChoice 가, 라
\kfChoice 나, 다
\kfChoice 가, 나, 다
...
\begin{kfQBlock}{20}{객관식}
\kfQStem{다음 중 단어와 그 반의어가 바르게 짝지어지지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
\kfChoice 장점 ↔ 단점
\kfChoice 절약 ↔ 판매
\kfChoice 구매 ↔ 판매
...
\begin{kfChapterAreaList}
\kfChapterAreaItem{어휘}{kfAreaVocab}{}
\kfChapterAreaItem{개념}{kfAreaConcept}{문장 성분 (주어, 서술어)}
\kfChapterAreaItem{문학}{kfAreaLiterature}{배경 지식 돋보기}
\kfChapterAreaItem{비문학}{kfAreaNonlit}{사실과 의견, 무엇이 다를까?}
\kfChapterAreaItem{실력확인}{kfAreaWeekly}{}
\end{kfChapterAreaList}
...
\begin{kfQBlock}{01}{객관식}
\kfQStem{다음 중 '객관적'과 뜻이 비슷하지 \underline{않은} 단어는 무엇인가요?}
\begin{kfChoices}
\kfChoice 사실적
\kfChoice 주관적
\kfChoice 합리적
...
\end{kfQBlock}
\begin{kfQBlock}{02}{객관식}
\kfQStem{다음 중 '사실'과 뜻이 같은 부류가 \underline{아닌} 단어는 무엇인가요?}
\begin{kfChoices}
\kfChoice 진실
\kfChoice 실제
\kfChoice 의견
...
\kfActivityBg \par\kfMaybeNeedspace{24\baselineskip}\noindent{\kfTipMark\,\,}{\small\color{kfInk} [1-10] 다음 문장에서 주어 또는 서술어를 찾아보세요.}\par\nopagebreak[4]\smallskip\nopagebreak[4]
\begin{kfBlankList}
...
\begin{kfQBlock}{01}{객관식}
\kfQStem{다음 빈칸에 들어갈 주어로 알맞지 \uline{\underline{않은}} 것은 무엇인가요?}
...
\end{kfQBlock}
\begin{kfQBlock}{02}{객관식}
\kfQStem{빈칸에 들어갈 주어로 알맞지 \uline{\underline{않은}} 것은 무엇인가요?}
...
\end{kfQBlock}
\begin{kfQBlock}{05}{객관식}
\kfQStem{다음 빈칸에 들어갈 서술어로 알맞지 \uline{\underline{않은}} 것은 무엇인가요?}
...
\kfActivityBg \par\kfMaybeNeedspace{24\baselineskip}\noindent{\kfTipMark\,\,}{\small\color{kfInk} [1-2] 다음 인물이 상징하는 것을 바르게 선으로 연결해 보세요.}\par\nopagebreak[4]\smallskip\nopagebreak[4]
\begin{kfConnect}
\kfPair{토끼}{㉡ 힘은 없지만 지혜로운 백성 (서민)}
\kfPair{용왕}{㉠ 힘은 세지만 어리석은 지배층 (권력자)}
\end{kfConnect}

\kfActivityBg \par\kfMaybeNeedspace{24\baselineskip}\noindent{\kfTipMark\,\,}{\small\color{kfInk} [1-4] 다음 중 지문에 나타난 '사실'에는 O, 토끼가 꾸며낸 '거짓 주장'에는 X 하세요.}\par\nopagebreak[4]\smallskip\nopagebreak[4]
\begin{kfOXList}
...
\kfActivityBg \par\kfMaybeNeedspace{24\baselineskip}\noindent{\kfTipMark\,\,}{\small\color{kfInk} [1-6] 글의 내용과 일치하면 O, 일치하지 않으면 X를 쓰세요.}\par\nopagebreak[4]\smallskip\nopagebreak[4]
\begin{kfOXList}
...
\end{kfQBlock}
\begin{kfQBlock}{02}{객관식}
\kfQStem{'㉡그 말'이 가리키는 내용으로 적절하지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{11}{단답형}
\kfQStem{토끼전처럼 원래는 소리꾼이 부르던 \kfFillBlank[30mm]{}였는데, 나중에 글로 적혀 소설이 된 것을 '\kfFillBlank[30mm]{}계 소설'이라고 합니다.}
\kfAnswerLines{1}
\end{kfQBlock}
\begin{kfQBlock}{12}{단답형}
\kfQStem{토끼의 주장: “제 간은 지금 배 속에 없고, 육지에 두고 왔습니다.” 근거 1: “육지에는 \kfFillBlank[30mm]{}이/가 많아서 배 속에 넣고 다니면 위험하기 때문입니다.” 근거 2: “평소에는 깊은 산속 \kfFillBlank[30mm]{} 밑에 잘 감추어 둡니다.”}
\kfAnswerLines{1}
\end{kfQBlock}
\begin{kfQBlock}{13}{단답형}
\kfQStem{용왕의 병을 고치기 위해 \kfFillBlank[30mm]{}가 토끼를 꾀어 용궁으로 데려간다.}
\kfAnswerLines{1}
\end{kfQBlock}
\begin{kfQBlock}{14}{단답형}
\kfQStem{용왕이 토끼의 \kfFillBlank[30mm]{}을/를 꺼내려 하자, 나졸들이 토끼를 묶는다.}
\kfAnswerLines{1}
\end{kfQBlock}
\begin{kfQBlock}{15}{단답형}
\kfQStem{토끼가 간을 넣었다 뺐다 할 수 있으며, 간을 \kfFillBlank[30mm]{}에 두고 왔다는 꾀를 낸다.}
\kfAnswerLines{1}
\end{kfQBlock}
\begin{kfQBlock}{16}{단답형}
\kfQStem{용왕은 토끼의 말을 믿고, 토끼를 다시 육지로 \kfFillBlank[30mm]{} 주기로 한다.}
\kfAnswerLines{1}
\end{kfQBlock}
...
\end{kfQBlock}
\begin{kfQBlock}{02}{객관식}
\kfQStem{'㉡그것'이 가리키는 내용으로 알맞지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{04}{객관식}
\kfQStem{다음 중 '사실'을 설명하는 문장으로 가장 적절하지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
...
\end{kfQBlock}
\begin{kfQBlock}{05}{객관식}
\kfQStem{글쓴이가 사실과 의견을 구분해야 한다고 강조한 이유로 적절하지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
...
\begin{kfEvidence}변호사: “피고인이 죄가 없다는 것은 분명한 사실입니다.” \\\relax
판사: “그 주장을 믿으려면 증거를 들어서 [　　　　　]해야 합니다. 말만으로는 부족합니다.”\end{kfEvidence}
\begin{kfChoices}
\kfChoice 비판
\kfChoice 입증
\kfChoice 결론
...
\begin{kfQBlock}{08}{객관식}
\kfQStem{토끼가 말한 '거짓말의 근거'로 적절하지 \uline{\underline{않은}} 것은 무엇인가요?}
\begin{kfChoices}
...
\begin{kfEvidence}「토끼전」은 조선 후기 평범한 백성들의 생각을 담은 이야기입니다. 이 이야기 속에 등장하는 동물들은 당시 사회의 다양한 사람들의 모습을 상징합니다. \\\relax
　* 토끼: 힘은 없지만 꾀와 지혜를 발휘하여 위기를 극복하는 '힘없는 백성' \\\relax
　* 용왕: 자신의 욕심을 채우기 위해 백성을 희생시키려는 '무능하고 부패한 지배층'\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfEvidence}ㄱ. 닭 쫓던 개 지붕 쳐다본다. \\\relax
ㄴ. 원숭이도 나무에서 떨어질 때가 있다. \\\relax
ㄷ. 얌전한 고양이 부뚜막에 먼저 올라간다. \\\relax
ㄹ. 호랑이에게 물려가도 정신만 차리면 산다.\end{kfEvidence}
\begin{kfChoices}
\kfChoice ㄱ
\kfChoice ㄴ
\kfChoice ㄷ
...
\begin{kfQBlock}{11}{객관식}
\kfQStem{위 글의 내용을 바탕으로 할 때, <보기>의 학생들 중 적절하지 \uline{\underline{않은}} 생각을 가진 학생은 누구인가요?}
\begin{kfEvidence}* 지수: “사실은 누가 봐도 똑같아야 하니까 증거를 통해 진짜인지 가짜인지 증명할 수 있어야 해.” \\\relax
　* 민호: “의견은 사람마다 생각이 다를 수 있으니까 친구의 의견이 내 생각과 조금 달라도 이해해야 해.” \\\relax
　* 영희: “사실과 의견을 헷갈리면 한 사람의 주관적인 생각을 마치 모두가 인정하는 사실인 것처럼 잘못 믿을 수도 있어.” \\\relax
　* 철수: “의견은 자기만의 느낌이나 생각을 자유롭게 말하는 거니까 그 의견이 타당한지 근거를 따져 볼 필요는 없어.”\end{kfEvidence}
\begin{kfChoices}
\kfChoice 지수
\kfChoice 민호
\kfChoice 영희
...
\begin{kfEvidence}민수: “야, 이 건강음료 좀 봐! 광고에 '세상에서 가장 맛있는 음료'라고 적혀 있어. 게다가 '마시면 누구나 힘이 불끈 솟는다'고 하네. 이건 정말 대단한 음료수가 분명해! 꼭 사 먹어야지.”\end{kfEvidence}
\begin{kfChoices}
...
\begin{kfQBlock}{15}{객관식}
\kfQStem{다음 '의견' 문장을 객관적인 '사실' 문장으로 바꾸어 표현할 때, 가장 적절하지 \uline{\underline{않은}} 것은?}
...
\begin{kfEvidence}이 성분은 문장의 주인입니다. 동작이나 상태의 주체가 되며, 주로 '누가', '무엇이'에 해당합니다.\end{kfEvidence}
\begin{kfChoices}
\kfChoice 선생님께서 오신다.
\kfChoice 어제 도서관에 갔어.
\kfChoice 꽃이 예쁘게 피었다.
...
\begin{kfEvidence}㉠ 내 장래 희망은 훌륭한 요리사가 되고 싶다. \\\relax
㉡ 내가 학교에 늦은 까닭은 버스를 놓쳤기 때문이다. \\\relax
㉢ 이 가방의 장점은 주머니가 많아서 편리하다는 점이다. \\\relax
㉣ 우리가 해야 할 일은 교실을 깨끗이 청소하자.\end{kfEvidence}
\begin{kfChoices}
\kfChoice ㉠, ㉡
\kfChoice ㉠, ㉣
\kfChoice ㉡, ㉢
